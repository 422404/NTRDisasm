...
#define id x
	...
	MakeDword	(0X1017EC);
	MakeCode	(0X1017F0);
	MakeName	(0X1017F0,	"write_color");
	MakeCode	(0X101800);
	MakeName	(0X101800,	"write_byte");
	MakeCode	(0X101808);
	MakeName	(0X101808,	"nibble_to_readable");
	MakeCode	(0X10181C);
	MakeCode	(x=0X10182C);
	OpHex		(x,	1);
	MakeCode	(0X101854);
	MakeCode	(0X101858);
	MakeName	(0X101858,	"u32_to_string");
	MakeCode	(0X1018AC);
	MakeCode	(0X1018B0);
	MakeName	(0X1018B0,	"svc_sleepThread");
	MakeCode	(0X1018B8);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X103284);
	MakeName	(0X103284,	"OS_ConvertVaddr2Physaddr");
	MakeCode	(0X103298);
	MakeCode	(0X1032AC);
	MakeCode	(0X1032C0);
	MakeCode	(x=0X1032C8);
	...
	OpStkvar	(x,	1);
	MakeCode	(0X1067DC);
	MakeName	(0X1067DC,	"svc_exitProcess");
	MakeCode	(0X1067E4);
	...
	MakeCode	(x=0X106814);
	OpStkvar	(x,	1);
	MakeName	(0X106814,	"svc_createMutex");
	MakeCode	(x=0X10681C);
	OpStkvar	(x,	1);
	MakeCode	(0X106828);
	MakeName	(0X106828,	"svc_releaseMutex");
	MakeCode	(x=0X106830);
	OpStkvar	(x,	1);
	MakeName	(0X106830,	"svc_releaseSemaphore");
	MakeCode	(x=0X106838);
	OpStkvar	(x,	1);
	MakeCode	(x=0X106844);
	OpStkvar	(x,	1);
	MakeName	(0X106844,	"svc_createEvent");
	MakeCode	(x=0X10684C);
	OpStkvar	(x,	1);
	MakeCode	(0X106858);
	MakeName	(0X106858,	"svc_signalEvent");
	MakeCode	(0X106860);
	MakeName	(0X106860,	"svc_clearEvent");
	MakeCode	(x=0X106868);
	OpStkvar	(x,	1);
	...
	OpStkvar	(x,	1);
	MakeCode	(0X106880);
	MakeName	(0X106880,	"svc_mapMemoryBlock");
	MakeCode	(0X106888);
	MakeName	(0X106888,	"svc_unmapMemoryBlock");
	MakeCode	(0X106890);
	MakeName	(0X106890,	"svc_arbitrateAddress");
	MakeCode	(0X106898);
	MakeName	(0X106898,	"CloseHandle");
	MakeCode	(0X1068A0);
	MakeName	(0X1068A0,	"svc_waitSynchronization1");
	MakeCode	(x=0X1068A8);
	OpStkvar	(x,	1);
	MakeName	(0X1068A8,	"svc_waitSynchronizationN");
	MakeCode	(x=0X1068B0);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1068B4);
	OpStkvar	(x,	1);
...
#define id x
	...
	MakeCode	(0X1068C8);
	MakeName	(0X1068C8,	"svc_getSystemTick");
	MakeCode	(0X1068D0);
	MakeName	(0X1068D0,	"svc_getSystemInfo");
	MakeCode	(x=0X1068D8);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1068E4);
	OpStkvar	(x,	1);
	MakeCode	(0X1068EC);
	MakeName	(0X1068EC,	"svc_getProcessInfo");
	MakeCode	(x=0X1068F4);
	OpStkvar	(x,	1);
	MakeCode	(x=0X106900);
	OpStkvar	(x,	1);
	...
	MakeCode	(x=0X106938);
	OpStkvar	(x,	1);
	MakeName	(0X106938,	"svc_getThreadId");
	MakeCode	(x=0X106940);
	OpStkvar	(x,	1);
	MakeCode	(0X10694C);
	MakeName	(0X10694C,	"svc_setThreadIdealProcessor");
	MakeCode	(x=0X106954);
	OpStkvar	(x,	1);
	...
	MakeCode	(0X106978);
	MakeName	(0X106978,	"svc_queryMemory");
	MakeCode	(0X106980);
	MakeName	(0X106980,	"svc_addCodeSegment");
	MakeCode	(0X106988);
	MakeCode	(x=0X106990);
	OpStkvar	(x,	1);
	...
	OpStkvar	(x,	1);
	MakeCode	(0X1069BC);
	MakeName	(0X1069BC,	"svc_mapProcessMemory");
	MakeCode	(0X1069C4);
	...
	OpStkvar	(x,	1);
	MakeCode	(0X106A28);
	MakeName	(0X106A28,	"svc_getThreadContext");
	MakeCode	(x=0X106A30);
	OpStkvar	(x,	1);
	...
	MakeCode	(0X106A4C);
	MakeName	(0X106A4C,	"svc_writeProcessMemory");
	MakeByte	(0X106A54);
...
static Functions_0(void) {
	...
	SetFunctionFlags(0X104ACC,0x444);
	...
	SetFunctionFlags(0X104B30,0x444);
	...
	SetFunctionFlags(0X104F68,0x444);
	...
	SetFunctionFlags(0X1067BC,0x444);
	...
	SetFunctionFlags(0X1067DC,0x444);
	MakeFunction    (0X1067E4,0X106804);
	SetFunctionFlags(0X1067E4,0x444);
	...
	SetFunctionFlags(0X106954,0x444);
	...
	SetFunctionFlags(0X106978,0x444);
	MakeFunction    (0X106980,0X106988);
	SetFunctionFlags(0X106980,0x444);
	MakeFunction    (0X106990,0X1069A4);
	SetFunctionFlags(0X106990,0x444);
	MakeFrame(0X106990, 0X4, 0, 0);
	MakeFunction    (0X1069A4,0X1069BC);
	SetFunctionFlags(0X1069A4,0x444);
	...
	SetFunctionFlags(0X1069BC,0x444);
	MakeFunction    (0X1069C4,0X1069E4);
	SetFunctionFlags(0X1069C4,0x444);
	...
	SetFunctionFlags(0X106EBC,0x444);
	...
	SetFunctionFlags(0X1080D4,0x444);
