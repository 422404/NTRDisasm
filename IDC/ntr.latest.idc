...
static Enums_0(id) {
	...
	id = AddEnum(-1,"SHDR_type",0x1100000);
	AddConstEx(id,"VERTEX_SHDR",	0,	-1);
	AddConstEx(id,"GEOMETRY_SHDR",	0X1,	-1);
	id = AddEnum(-1,"SHDR_outType",0x1100000);
	AddConstEx(id,"RESULT_POSITION",	0,	-1);
	AddConstEx(id,"RESULT_COLOR",	0X2,	-1);
	AddConstEx(id,"RESULT_TEXCOORD0",	0X3,	-1);
	AddConstEx(id,"RESULT_TEXCOORD1",	0X5,	-1);
	AddConstEx(id,"RESULT_TEXCOORD2",	0X6,	-1);
	id = AddEnum(-1,"PAD_KEY",0x1100000);
	SetEnumBf(id,1);
	AddConstEx(id,"PAD_A",	0X1,	0x1);
	AddConstEx(id,"PAD_B",	0X2,	0x2);
	AddConstEx(id,"PAD_SELECT",	0X4,	0x4);
	AddConstEx(id,"PAD_START",	0X8,	0x8);
	AddConstEx(id,"PAD_RIGHT",	0X10,	0x10);
	AddConstEx(id,"PAD_LEFT",	0X20,	0x20);
	AddConstEx(id,"PAD_UP",	0X40,	0x40);
	AddConstEx(id,"PAD_DOWN",	0X80,	0x80);
	AddConstEx(id,"PAD_R",	0X100,	0x100);
	AddConstEx(id,"PAD_L",	0X200,	0x200);
	AddConstEx(id,"PAD_X",	0X400,	0x400);
	AddConstEx(id,"PAD_Y",	0X800,	0x800);
	id = AddEnum(-1,"CSND_ENCODING",0x1100000);
	AddConstEx(id,"CSND_ENCODING_PCM8",	0,	-1);
	AddConstEx(id,"CSND_ENCODING_PCM16",	0X1,	-1);
	AddConstEx(id,"CSND_ENCODING_IMA_ADPCM",	0X2,	-1);
	AddConstEx(id,"CSND_ENCODING_PSG",	0X3,	-1);
	id = AddEnum(-1,"CSND_LOOPING",0x1100000);
	AddConstEx(id,"CSND_LOOP_DISABLE",	0,	-1);
	AddConstEx(id,"CSND_LOOP_ENABLE",	0X1,	-1);
	id = AddEnum(-1,"APP_STATUS",0x1100000);
	AddConstEx(id,"APP_NOTINITIALIZED",	0,	-1);
	AddConstEx(id,"APP_RUNNING",	0X1,	-1);
	AddConstEx(id,"APP_SUSPENDED",	0X2,	-1);
	AddConstEx(id,"APP_EXITING",	0X3,	-1);
	AddConstEx(id,"APP_SUSPENDING",	0X4,	-1);
	AddConstEx(id,"APP_SLEEPMODE",	0X5,	-1);
	AddConstEx(id,"APP_PREPARE_SLEEPMODE",	0X6,	-1);
	id = AddEnum(-1,"NS_APPID",0x1100000);
	AddConstEx(id,"APPID_HOMEMENU",	0X101,	-1);
	AddConstEx(id,"APPID_CAMERA",	0X110,	-1);
	AddConstEx(id,"APPID_WEB",	0X114,	-1);
	AddConstEx(id,"APPID_APPLICATION",	0X300,	-1);
	id = AddEnum(-1,"GPU_COMBINEFUNC",0x1100000);
	AddConstEx(id,"GPU_REPLACE",	0,	-1);
	AddConstEx(id,"GPU_MODULATE",	0X1,	-1);
	AddConstEx(id,"GPU_ADD",	0X2,	-1);
	AddConstEx(id,"GPU_ADD_SIGNED",	0X3,	-1);
	AddConstEx(id,"GPU_INTERPOLATE",	0X4,	-1);
	AddConstEx(id,"GPU_SUBTRACT",	0X5,	-1);
	AddConstEx(id,"GPU_DOT3_RGB",	0X6,	-1);
	id = AddEnum(-1,"GPU_TEVSRC",0x1100000);
	AddConstEx(id,"GPU_PRIMARY_COLOR",	0,	-1);
	AddConstEx(id,"GPU_TEXTURE0",	0X3,	-1);
	AddConstEx(id,"GPU_TEXTURE1",	0X4,	-1);
	AddConstEx(id,"GPU_TEXTURE2",	0X5,	-1);
	AddConstEx(id,"GPU_TEXTURE3",	0X6,	-1);
	AddConstEx(id,"GPU_CONSTANT",	0XE,	-1);
	AddConstEx(id,"GPU_PREVIOUS",	0XF,	-1);
	id = AddEnum(-1,"GPU_CULLMODE",0x1100000);
	AddConstEx(id,"GPU_CULL_NONE",	0,	-1);
	AddConstEx(id,"GPU_CULL_FRONT_CCW",	0X1,	-1);
	AddConstEx(id,"GPU_CULL_BACK_CCW",	0X2,	-1);
	id = AddEnum(-1,"GPU_FORMATS",0x1100000);
	AddConstEx(id,"GPU_BYTE",	0,	-1);
	AddConstEx(id,"GPU_UNSIGNED_BYTE",	0X1,	-1);
	AddConstEx(id,"GPU_SHORT",	0X2,	-1);
	AddConstEx(id,"GPU_FLOAT",	0X3,	-1);
	id = AddEnum(-1,"GPU_TESTFUNC",0x1100000);
	AddConstEx(id,"GPU_NEVER",	0,	-1);
	AddConstEx(id,"GPU_ALWAYS",	0X1,	-1);
	AddConstEx(id,"GPU_EQUAL",	0X2,	-1);
	AddConstEx(id,"GPU_NOTEQUAL",	0X3,	-1);
	AddConstEx(id,"GPU_LESS",	0X4,	-1);
	AddConstEx(id,"GPU_LEQUAL",	0X5,	-1);
	AddConstEx(id,"GPU_GREATER",	0X6,	-1);
	AddConstEx(id,"GPU_GEQUAL",	0X7,	-1);
	id = AddEnum(-1,"GPU_TEXCOLOR",0x1100000);
	AddConstEx(id,"GPU_RGBA8",	0,	-1);
	AddConstEx(id,"GPU_RGB8",	0X1,	-1);
	AddConstEx(id,"GPU_RGBA5551",	0X2,	-1);
	AddConstEx(id,"GPU_RGB565",	0X3,	-1);
	AddConstEx(id,"GPU_RGBA4",	0X4,	-1);
	AddConstEx(id,"GPU_LA8",	0X5,	-1);
	AddConstEx(id,"GPU_HILO8",	0X6,	-1);
	AddConstEx(id,"GPU_L8",	0X7,	-1);
	AddConstEx(id,"GPU_A8",	0X8,	-1);
	AddConstEx(id,"GPU_LA4",	0X9,	-1);
	AddConstEx(id,"GPU_L4",	0XA,	-1);
	AddConstEx(id,"GPU_ETC1",	0XB,	-1);
	AddConstEx(id,"GPU_ETC1A4",	0XC,	-1);
	id = AddEnum(-1,"ThreadInfoType",0x1100000);
	AddConstEx(id,"THREADINFO_TYPE_UNKNOWN",	0,	-1);
	id = AddEnum(-1,"UserBreakType",0x1100000);
	AddConstEx(id,"USERBREAK_PANIC",	0,	-1);
	AddConstEx(id,"USERBREAK_ASSERT",	0X1,	-1);
	AddConstEx(id,"USERBREAK_USER",	0X2,	-1);
	id = AddEnum(-1,"ExceptionEventType",0x1100000);
	AddConstEx(id,"EXC_EVENT_UNDEFINED_INSTRUCTION",	0,	-1);
	AddConstEx(id,"EXC_EVENT_UNKNOWN1",	0X1,	-1);
	AddConstEx(id,"EXC_EVENT_UNKNOWN2",	0X2,	-1);
	AddConstEx(id,"EXC_EVENT_UNKNOWN3",	0X3,	-1);
	AddConstEx(id,"EXC_EVENT_ATTACH_BREAK",	0X4,	-1);
	AddConstEx(id,"EXC_EVENT_BREAKPOINT",	0X5,	-1);
	AddConstEx(id,"EXC_EVENT_USER_BREAK",	0X6,	-1);
	AddConstEx(id,"EXC_EVENT_DEBUGGER_BREAK",	0X7,	-1);
	AddConstEx(id,"EXC_EVENT_UNDEFINED_SYSCALL",	0X8,	-1);
	id = AddEnum(-1,"ExitProcessEventReason",0x1100000);
	AddConstEx(id,"EXITPROCESS_EVENT_NONE",	0,	-1);
	AddConstEx(id,"EXITPROCESS_EVENT_TERMINATE",	0X1,	-1);
	AddConstEx(id,"EXITPROCESS_EVENT_UNHANDLED_EXCEPTION",	0X2,	-1);
	id = AddEnum(-1,"ExitThreadEventReason",0x1100000);
	AddConstEx(id,"EXITTHREAD_EVENT_NONE",	0,	-1);
	AddConstEx(id,"EXITTHREAD_EVENT_TERMINATE",	0X1,	-1);
	AddConstEx(id,"EXITTHREAD_EVENT_UNHANDLED_EXC",	0X2,	-1);
	AddConstEx(id,"EXITTHREAD_EVENT_TERMINATE_PROCESS",	0X3,	-1);
	id = AddEnum(-1,"ProcessEventReason",0x1100000);
	SetEnumBf(id,1);
	AddConstEx(id,"REASON_CREATE",	0X1,	0x1);
	AddConstEx(id,"REASON_ATTACH",	0X2,	0x2);
	id = AddEnum(-1,"DebugEventType",0x1100000);
	AddConstEx(id,"DBG_EVENT_PROCESS",	0,	-1);
	AddConstEx(id,"DBG_EVENT_CREATE_THREAD",	0X1,	-1);
	AddConstEx(id,"DBG_EVENT_EXIT_THREAD",	0X2,	-1);
	AddConstEx(id,"DBG_EVENT_EXIT_PROCESS",	0X3,	-1);
	AddConstEx(id,"DBG_EVENT_EXCEPTION",	0X4,	-1);
	AddConstEx(id,"DBG_EVENT_DLL_LOAD",	0X5,	-1);
	AddConstEx(id,"DBG_EVENT_DLL_UNLOAD",	0X6,	-1);
	AddConstEx(id,"DBG_EVENT_SCHEDULE_IN",	0X7,	-1);
	AddConstEx(id,"DBG_EVENT_SCHEDULE_OUT",	0X8,	-1);
	AddConstEx(id,"DBG_EVENT_SYSCALL_IN",	0X9,	-1);
	AddConstEx(id,"DBG_EVENT_SYSCALL_OUT",	0XA,	-1);
	AddConstEx(id,"DBG_EVENT_OUTPUT_STRING",	0XB,	-1);
	AddConstEx(id,"DBG_EVENT_MAP",	0XC,	-1);
	id = AddEnum(-1,"MemState",0x1100000);
	AddConstEx(id,"MEMSTATE_FREE",	0,	-1);
	AddConstEx(id,"MEMSTATE_RESERVED",	0X1,	-1);
	AddConstEx(id,"MEMSTATE_IO",	0X2,	-1);
	AddConstEx(id,"MEMSTATE_STATIC",	0X3,	-1);
	AddConstEx(id,"MEMSTATE_CODE",	0X4,	-1);
	AddConstEx(id,"MEMSTATE_PRIVATE",	0X5,	-1);
	AddConstEx(id,"MEMSTATE_SHARED",	0X6,	-1);
	AddConstEx(id,"MEMSTATE_CONTINUOUS",	0X7,	-1);
	AddConstEx(id,"MEMSTATE_ALIASED",	0X8,	-1);
	AddConstEx(id,"MEMSTATE_ALIAS",	0X9,	-1);
	AddConstEx(id,"MEMSTATE_ALIASCODE",	0XA,	-1);
	AddConstEx(id,"MEMSTATE_LOCKED",	0XB,	-1);
	id = AddEnum(-1,"MEMORY_OPERATION",0x1100000);
	AddConstEx(id,"MEMOP_RESERVE",	0X2,	-1);
	AddConstEx(id,"MEMOP_COMMIT",	0X3,	-1);
	AddConstEx(id,"MEMOP_PROTECT",	0X6,	-1);
	AddConstEx(id,"MEMOP_REGION_APP",	0X100,	-1);
	AddConstEx(id,"MEMOP_REGION_SYSTEM",	0X200,	-1);
	AddConstEx(id,"MEMOP_REGION_BASE",	0X300,	-1);
	AddConstEx(id,"MEMOP_LINEAR",	0X1000,	-1);
	id = AddEnum(-1,"mediatypes_enum",0x1100000);
	AddConstEx(id,"mediatype_NAND",	0,	-1);
	AddConstEx(id,"mediatype_SDMC",	0X1,	-1);
	AddConstEx(id,"mediatype_GAMECARD",	0X2,	-1);
	return id;
}
...
static Structures_0(id) {
	...
	id = AddStrucEx(-1,"_PLGLOADER_INFO",0);
	id = AddStrucEx(-1,"hostent",0);
	id = AddStrucEx(-1,"DVLB_s",0);
	id = AddStrucEx(-1,"DVLP_s",0);
	id = AddStrucEx(-1,"DVLE_s",0);
	id = AddStrucEx(-1,"DVLE_uniformEntry_s",0);
	id = AddStrucEx(-1,"DVLE_outEntry_s",0);
	id = AddStrucEx(-1,"DVLE_constEntry_s",0);
	id = AddStrucEx(-1,"GSP_CaptureInfo",0);
	id = AddStrucEx(-1,"GSP_CaptureInfoEntry",0);
	id = AddStrucEx(-1,"GSP_FramebufferInfo",0);
	id = AddStrucEx(-1,"PLGLOADER_INFO",0);
	id = AddStrucEx(-1,"DebugEventInfo",0);
	id = AddStrucEx(-1,"$8AA324A4CF3253467AC9A6634CDF8269::$B82C120C411F03FCE493E0E12447366E",1);
	id = AddStrucEx(-1,"ProcessEvent",0);
	id = AddStrucEx(-1,"CreateThreadEvent",0);
	id = AddStrucEx(-1,"ExitThreadEvent",0);
	id = AddStrucEx(-1,"ExitProcessEvent",0);
	id = AddStrucEx(-1,"ExceptionEvent",0);
	id = AddStrucEx(-1,"SchedulerInOutEvent",0);
	id = AddStrucEx(-1,"SyscallInOutEvent",0);
	id = AddStrucEx(-1,"OutputStringEvent",0);
	id = AddStrucEx(-1,"MapEvent",0);
	id = AddStrucEx(-1,"PageInfo",0);
	id = AddStrucEx(-1,"MemInfo",0);
	id = AddStrucEx(-1,"NS_CONFIG",0);
	id = AddStrucEx(-1,"NS_BREAKPOINT",0);
	id = AddStrucEx(-1,"RT_HOOK",0);
	id = AddStrucEx(-1,"_NS_CONFIG",0);
	id = AddStrucEx(-1,"_NS_BREAKPOINT",0);
	id = AddStrucEx(-1,"_RT_HOOK",0);
	id = AddStrucEx(-1,"_RT_LOCK",0);
	...
	id = GetStrucIdByName("_PLGLOADER_INFO");
	...
	id = GetStrucIdByName("DVLP_s");
	mid = AddStrucMember(id,"codeSize",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"codeData",	0X4,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = AddStrucMember(id,"opdescSize",	0X8,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"opcdescData",	0XC,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	
	id = GetStrucIdByName("DVLB_s");
	mid = AddStrucMember(id,"numDVLE",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"DVLP",	0X4,	0x60000400,	GetStrucIdByName("DVLP_s"),	16);
	mid = AddStrucMember(id,"DVLE",	0X14,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	
	id = GetStrucIdByName("DVLE_s");
	mid = AddStrucMember(id,"type",	0,	0x28800400,	GetEnum("SHDR_type"),	4);
	mid = AddStrucMember(id,"mainOffset",	0X4,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"endmainOffset",	0X8,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"constTableSize",	0XC,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"constTableData",	0X10,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = AddStrucMember(id,"outTableSize",	0X14,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"outTableData",	0X18,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = AddStrucMember(id,"uniformTableSize",	0X1C,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"uniformTableData",	0X20,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = AddStrucMember(id,"symbolTableData",	0X24,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	
	id = GetStrucIdByName("DVLE_uniformEntry_s");
	mid = AddStrucMember(id,"symbolOffset",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"startReg",	0X4,	0x10000400,	-1,	2);
	mid = AddStrucMember(id,"endReg",	0X6,	0x10000400,	-1,	2);
	
	id = GetStrucIdByName("DVLE_outEntry_s");
	mid = AddStrucMember(id,"type",	0,	0x10000400,	-1,	2);
	mid = AddStrucMember(id,"regID",	0X2,	0x10000400,	-1,	2);
	mid = AddStrucMember(id,"header",	0X4,	0x20000400,	-1,	4);
	
	id = GetStrucIdByName("DVLE_constEntry_s");
	mid = AddStrucMember(id,"header",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"data",	0X4,	0x20000400,	-1,	16);
	
	id = GetStrucIdByName("GSP_CaptureInfoEntry");
	mid = AddStrucMember(id,"framebuf0_vaddr",	0,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = AddStrucMember(id,"framebuf1_vaddr",	0X4,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = AddStrucMember(id,"format",	0X8,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"framebuf_widthbytesize",	0XC,	0x20000400,	-1,	4);
	
	id = GetStrucIdByName("GSP_CaptureInfo");
	mid = AddStrucMember(id,"screencapture",	0,	0x60000400,	GetStrucIdByName("GSP_CaptureInfoEntry"),	32);
	
	id = GetStrucIdByName("GSP_FramebufferInfo");
	mid = AddStrucMember(id,"active_framebuf",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"framebuf0_vaddr",	0X4,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = AddStrucMember(id,"framebuf1_vaddr",	0X8,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	mid = AddStrucMember(id,"framebuf_widthbytesize",	0XC,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"format",	0X10,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"framebuf_dispselect",	0X14,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"unk",	0X18,	0x20000400,	-1,	4);
	...
	id = GetStrucIdByName("ProcessEvent");
	mid = AddStrucMember(id,"program_id",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"process_name",	0X4,	0x000400,	-1,	8);
	mid = AddStrucMember(id,"process_id",	0XC,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"reason",	0X10,	0x20000400,	-1,	4);
	
	id = GetStrucIdByName("CreateThreadEvent");
	mid = AddStrucMember(id,"creator_thread_id",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"base_addr",	0X4,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"entry_point",	0X8,	0x20000400,	-1,	4);
	
	id = GetStrucIdByName("ExitThreadEvent");
	mid = AddStrucMember(id,"reason",	0,	0x20000400,	-1,	4);
	
	id = GetStrucIdByName("ExitProcessEvent");
	mid = AddStrucMember(id,"reason",	0,	0x20000400,	-1,	4);
	
	id = GetStrucIdByName("ExceptionEvent");
	mid = AddStrucMember(id,"type",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"address",	0X4,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"argument",	0X8,	0x20000400,	-1,	4);
	
	id = GetStrucIdByName("SchedulerInOutEvent");
	mid = AddStrucMember(id,"clock_tick",	0,	0x20000400,	-1,	4);
	
	id = GetStrucIdByName("SyscallInOutEvent");
	mid = AddStrucMember(id,"clock_tick",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"syscall",	0X4,	0x20000400,	-1,	4);
	
	id = GetStrucIdByName("OutputStringEvent");
	mid = AddStrucMember(id,"string_addr",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"string_size",	0X4,	0x20000400,	-1,	4);
	
	id = GetStrucIdByName("MapEvent");
	mid = AddStrucMember(id,"mapped_addr",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"mapped_size",	0X4,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"memperm",	0X8,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"memstate",	0XC,	0x20000400,	-1,	4);
	
	id = GetStrucIdByName("$8AA324A4CF3253467AC9A6634CDF8269::$B82C120C411F03FCE493E0E12447366E");
	mid = AddStrucMember(id,"process",	0,	0x60000400,	GetStrucIdByName("ProcessEvent"),	20);
	mid = AddStrucMember(id,"create_thread",	0,	0x60000400,	GetStrucIdByName("CreateThreadEvent"),	12);
	mid = AddStrucMember(id,"exit_thread",	0,	0x60000400,	GetStrucIdByName("ExitThreadEvent"),	4);
	mid = AddStrucMember(id,"exit_process",	0,	0x60000400,	GetStrucIdByName("ExitProcessEvent"),	4);
	mid = AddStrucMember(id,"exception",	0,	0x60000400,	GetStrucIdByName("ExceptionEvent"),	12);
	mid = AddStrucMember(id,"scheduler",	0,	0x60000400,	GetStrucIdByName("SchedulerInOutEvent"),	4);
	mid = AddStrucMember(id,"syscall",	0,	0x60000400,	GetStrucIdByName("SyscallInOutEvent"),	8);
	mid = AddStrucMember(id,"output_string",	0,	0x60000400,	GetStrucIdByName("OutputStringEvent"),	8);
	mid = AddStrucMember(id,"map",	0,	0x60000400,	GetStrucIdByName("MapEvent"),	16);
	
	id = GetStrucIdByName("DebugEventInfo");
	mid = AddStrucMember(id,"type",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"thread_id",	0X4,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"unknown",	0X8,	0x20000400,	-1,	8);
	mid = AddStrucMember(id,"anonymous_0",	0X10,	0x60000400,	GetStrucIdByName("$8AA324A4CF3253467AC9A6634CDF8269::$B82C120C411F03FCE493E0E12447366E"),	20);
	
	id = GetStrucIdByName("PageInfo");
	mid = AddStrucMember(id,"flags",	0,	0x20000400,	-1,	4);
	
	id = GetStrucIdByName("MemInfo");
	mid = AddStrucMember(id,"base_addr",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"size",	0X4,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"perm",	0X8,	0x20000400,	-1,	4);
	...
	id = GetStrucIdByName("_NS_CONFIG");
	mid = AddStrucMember(id,"initMode",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"startupCommand",	0X4,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"hSOCU",	0X8,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"debugBuf",	0XC,	0x25500400,	0XFFFFFFFF,	4,	0XFFFFFFFF,	0,	0x000002);
	...
	mid = AddStrucMember(id,"debugPtr",	0X14,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"debugReady",	0X18,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"debugBufferLock",	0X1C,	0x60000400,	GetStrucIdByName("RT_LOCK"),	4);
	mid = AddStrucMember(id,"startupInfo",	0X20,	0x20000400,	-1,	128);
	mid = AddStrucMember(id,"allowDirectScreenAccess",	0XA0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"exitFlag",	0XA4,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"sharedFunc",	0XA8,	0x20000400,	-1,	400);
	
	id = GetStrucIdByName("_NS_BREAKPOINT");
	mid = AddStrucMember(id,"type",	0,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"flag",	0X4,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"addr",	0X8,	0x20000400,	-1,	4);
	mid = AddStrucMember(id,"hook",	0XC,	0x60000400,	GetStrucIdByName("RT_HOOK"),	204);
...
#define id x
	...
	ExtLinA		(0X100100,	3,	"; File Name   : ntr.bin");
	ExtLinA		(0X100100,	4,	"; Format      : Binary file");
	ExtLinA		(0X100100,	5,	"; Base Address: 0000h Range: 0000h - B08Ch Loaded length: B08Ch");
	MakeCode	(0X100100);
	MakeName	(0X100100,	"ntrBase");
	MakeDword	(0X100104);
	MakeName	(0X100104,	"nsDbgPrint_");
	MakeDword	(0X100108);
	MakeDword	(0X10010C);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X100180,	"ntrReinstall");
	...
	MakeComm	(0X10065C,	"threadpriority");
	MakeCode	(x=0X10065C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X10065C,	"ntrInstall");
	...
	MakeCode	(0X100EEC);
	MakeName	(0X100EEC,	"threadSetupNetworkDebugServer");
	MakeDword	(0X100F18);
	MakeDword	(0X100F1C);
	MakeCode	(x=0X100F20);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X100F20,	"ntrClosePluginHandle?");
	MakeComm	(0X100F30,	"handle");
	MakeDword	(x=0X100F38);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X100F3C);
	MakeName	(0X100F3C,	"fatal_LR");
	MakeComm	(0X100F48,	"errno");
	MakeComm	(0X100F4C,	"fmt");
	MakeComm	(0X100F50,	"v2");
	MakeDword	(x=0X100F60);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeName	(0X100F60,	"fmt");
	MakeCode	(0X100F64);
	...
	MakeCode	(x=0X100FE8);
	OpStkvar	(x,	1);
	MakeComm	(0X100FF8,	"buff");
	MakeComm	(0X100FFC,	"fmt");
	MakeCode	(0X10100C);
	MakeCode	(x=0X101018);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X101110);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X101114);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	...
	MakeCode	(x=0X10114C);
	OpStkvar	(x,	1);
	MakeComm	(0X101154,	"handle");
	MakeCode	(x=0X101154);
	OpOff		(x,	1,	0X10ACF4);
	OpOff		(x,	129,	0X10ACF4);
	MakeComm	(0X101158,	"archive");
	MakeCode	(x=0X10115C);
	OpStkvar	(x,	1);
	MakeComm	(0X10116C,	"buff");
	MakeCode	(x=0X10116C);
	OpStkvar	(x,	1);
	MakeComm	(0X101170,	"fmt");
	MakeComm	(0X101178,	"msg");
	MakeCode	(x=0X101178);
	OpStkvar	(x,	1);
	MakeCode	(x=0X101184);
	OpOff		(x,	1,	0);
	...
	MakeCode	(x=0X10118C);
	OpStkvar	(x,	1);
	MakeComm	(0X1011A0,	"handle");
	MakeCode	(x=0X1011A0);
	OpOff		(x,	1,	0X10ACF4);
	OpOff		(x,	129,	0X10ACF4);
	MakeComm	(0X1011A4,	"archive");
	MakeDword	(0X1011B4);
	MakeDword	(x=0X1011B8);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X1011BC);
	MakeDword	(x=0X1011C0);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X1011C8,	"check_plugin_exit_flag");
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X101278);
	MakeName	(0X101278,	"threadNtrHomeInjectee");
	MakeCode	(x=0X10127C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X101280,	"funcaddr");
	MakeCode	(x=0X101280);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X101284,	"callback_addr");
	MakeCode	(x=0X101284);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X101288,	"hook");
	MakeComm	(0X10128C,	"hook FSFile:Read (statically linked into homemenu) in order to disable region lock");
	MakeComm	(0X101290,	"rthook");
	MakeCode	(x=0X101290);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X101298);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X10129C,	"callback_addr");
	MakeCode	(x=0X10129C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	MakeComm	(0X1012A8,	"hook nss:CardUpdateInitialize (statically linked into homemenu) in order to bypass mandatory cart updates");
	MakeComm	(0X1012AC,	"rthook");
	MakeCode	(x=0X1012AC);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X1012B4);
	...
	OpOff		(x,	1,	0X1085D4);
	OpOff		(x,	129,	0X1085D4);
	MakeComm	(0X101364,	"X & Y pressed?");
	MakeComm	(0X10139C,	"nanoseconds");
	...
	MakeDword	(0X1013F0);
	MakeCode	(0X1013F4);
	MakeName	(0X1013F4,	"ntrScreenShotCreate");
	MakeComm	(0X1013F8,	"processId");
	MakeComm	(0X1013FC,	"process");
	MakeComm	(0X10140C,	"handle");
	MakeCode	(x=0X10140C);
	OpStkvar	(x,	1);
	MakeCode	(x=0X101414);
	OpStkvar	(x,	1);
	MakeRptCmt	(0X101418,	"width");
	MakeComm	(0X101424,	"width");
	MakeComm	(0X101428,	"height");
	MakeComm	(0X101434,	"number of pixels");
	MakeRptCmt	(0X101438,	"width");
	MakeRptCmt	(0X10143C,	"height");
	MakeCode	(x=0X101440);
	OpStkvar	(x,	1);
	MakeComm	(0X101448,	"handle");
	MakeCode	(x=0X101448);
	OpStkvar	(x,	1);
	MakeCode	(0X101458);
	MakeName	(0X101458,	"prepare_config_mem");
	MakeCode	(x=0X10145C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X101460);
	...
	MakeComm	(0X101480,	"MEMPERM_READ | MEMPERM_WRITE");
	ExtLinA		(0X101480,	0,	"; on failure, fall back to RW only");
	ExtLinA		(0X101480,	1,	"");
	MakeComm	(0X101484,	"operation");
	MakeCode	(x=0X101484);
	OpStkvar	(x,	1);
	MakeComm	(0X101488,	"permissions");
	MakeCode	(x=0X101488);
	OpStkvar	(x,	1);
	MakeComm	(0X10148C,	"addr0");
	MakeComm	(0X101490,	"outaddr");
	MakeCode	(x=0X101490);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X1014DC);
	MakeName	(0X1014DC,	"inject_ntr_into_home_menu");
	MakeCode	(x=0X1014E8);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1014F4);
	OpOff		(x,	1,	0);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1014FC,	"offs 0x0C = func *");
	MakeCode	(x=0X1014FC);
	OpOff		(x,	1,	0X100104);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X10153C,	"buf");
	MakeCode	(x=0X10153C);
	OpStkvar	(x,	1);
	MakeComm	(0X101540,	"handle");
	MakeCode	(x=0X101540);
	OpStkvar	(x,	1);
	MakeComm	(0X101544,	"addr_jmpcode");
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X101570);
	MakeName	(0X101570,	"sleep_thread");
	MakeComm	(0X101578,	"nanoseconds");
	MakeDword	(0X101590);
	MakeCode	(0X101594);
	MakeName	(0X101594,	"close_all_srv_handles?");
	MakeComm	(0X1015A4,	"nanoseconds");
	MakeDword	(0X1015BC);
	MakeComm	(0X1015C0,	"ns");
	MakeCode	(0X1015C0);
	MakeDword	(0X1015D4);
	MakeComm	(0X1015D8,	"threadpriority");
	MakeCode	(0X1015D8);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X101694,	"pid");
	MakeComm	(0X101698,	"filename");
	MakeComm	(0X1016A0,	"pid");
	MakeComm	(0X1016A4,	"filename");
	MakeComm	(0X1016AC,	"pid");
	MakeComm	(0X1016B0,	"filename");
	MakeComm	(0X1016B8,	"pid");
	MakeComm	(0X1016BC,	"filename");
	MakeComm	(0X1016C4,	"va_dumpaddr");
	MakeComm	(0X1016C8,	"size");
	MakeComm	(0X1016CC,	"filename");
	MakeCode	(x=0X1016D4);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1016DC,	"nanoseconds");
	MakeCode	(0X1016EC);
	MakeCode	(x=0X1016F0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1016FC,	"errno");
	MakeCode	(x=0X1016FC);
	OpOff		(x,	1,	0X10ACF4);
	OpOff		(x,	129,	0X10ACF4);
	MakeComm	(0X101700,	"v2");
	MakeComm	(0X101704,	"fmt");
	MakeCode	(0X101720);
	MakeCode	(x=0X101728);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X101738,	"size");
	MakeComm	(0X101744,	"addr");
	MakeComm	(0X101758,	"dst");
	MakeComm	(0X10175C,	"src");
	MakeComm	(0X101764,	"size");
	MakeComm	(0X101768,	"addr");
	MakeCode	(x=0X101780);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X101790,	"current pid == pid of nintendo home menu?");
	ExtLinA		(0X10179C,	0,	"; this will be executed if we're running from");
	ExtLinA		(0X10179C,	1,	"; within nintendo home menu");
	ExtLinA		(0X10179C,	2,	"");
	MakeCode	(x=0X10179C);
	OpOff		(x,	1,	0X10ACF4);
	OpOff		(x,	129,	0X10ACF4);
	...
	MakeComm	(0X101808,	"stacktop");
	MakeComm	(0X101810,	"nanoseconds");
	MakeComm	(0X10181C,	"r8+8 = pid of pm (=2)");
	MakeComm	(0X101820,	"are we process manager?");
	ExtLinA		(0X101828,	0,	"; this will be executed if we're running from");
	ExtLinA		(0X101828,	1,	"; within the process manager and will be used");
	ExtLinA		(0X101828,	2,	"; to force it to inject code into nintendo home menu");
	ExtLinA		(0X101828,	3,	"");
	MakeCode	(0X101830);
	...
	OpOff		(x,	128,	0);
	MakeDword	(0X101890);
	MakeName	(0X101890,	"va_dumpaddr");
	MakeDword	(x=0X101894);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	...
	MakeCode	(0X1018EC);
	MakeName	(0X1018EC,	"ntrMemoryNibbleToReadable");
	MakeCode	(0X101900);
	MakeName	(0X101900,	"ntrMemoryByteToString");
	MakeCode	(x=0X101910);
	OpHex		(x,	1);
	MakeComm	(0X101920,	"nibble");
	MakeCode	(0X101938);
	MakeCode	(0X10193C);
	MakeName	(0X10193C,	"ntrMemoryU32ToString");
	MakeCode	(0X101990);
	MakeArray	(0X101994,	0XC);
	MakeCode	(0X1019A0);
	MakeName	(0X1019A0,	"sleep");
	MakeCode	(0X1019A8);
	MakeName	(0X1019A8,	"cb_arm11_dispatch");
	MakeComm	(0X1019B0,	"disable fiq and irq");
	MakeCode	(x=0X1019B0);
	OpHex		(x,	1);
	MakeCode	(0X1019C0);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X1019E0,	"init_debugger");
	MakeDword	(x=0X101A10);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeComm	(0X101A14,	"sends str to connected network client");
	MakeCode	(0X101A14);
	MakeName	(0X101A14,	"sendMsg");
	MakeCode	(x=0X101A1C);
	OpStkvar	(x,	1);
	MakeCode	(x=0X101A20);
	OpOff		(x,	1,	0);
	...
	MakeComm	(0X101A48,	"fmt");
	MakeCode	(x=0X101A48);
	OpStkvar	(x,	1);
	MakeComm	(0X101A4C,	"arp");
	MakeCode	(x=0X101A4C);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X101AA4,	"v2");
	MakeComm	(0X101AB0,	"errno");
	MakeCode	(x=0X101AD8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X101AF0,	"recv_wrapper");
	MakeComm	(0X101AF8,	"v2");
	MakeComm	(0X101B04,	"errno");
	MakeComm	(0X101B2C,	"fmt");
	MakeCode	(0X101B2C);
	MakeDword	(x=0X101B3C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X101B40);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X101B44);
	MakeName	(0X101B44,	"handle_savefile_packet");
	MakeComm	(0X101B48,	"size");
	MakeCode	(x=0X101B4C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X101B74,	"a1");
	MakeCode	(x=0X101B78);
	OpStkvar	(x,	1);
	MakeCode	(x=0X101B7C);
	OpStkvar	(x,	1);
	...
	MakeCode	(x=0X101BCC);
	OpStkvar	(x,	1);
	MakeComm	(0X101BD4,	"errno");
	MakeCode	(x=0X101BE8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X101BEC,	"v2");
	MakeCode	(0X101BF8);
	MakeComm	(0X101C24,	"offset");
	MakeComm	(0X101C30,	"handle");
	MakeCode	(x=0X101C30);
	OpStkvar	(x,	1);
	MakeComm	(0X101C38,	"bytesWritten");
	MakeCode	(x=0X101C38);
	OpStkvar	(x,	1);
	MakeComm	(0X101C3C,	"buffer");
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X101CC4,	"debugcmd_enable_breakpoint");
	MakeCode	(x=0X101CF0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X101D20,	"rthook");
	MakeComm	(0X101D28,	"msg");
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X101D40);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(x=0X101D44);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X101D44,	"debugcmd_disable_breakpoint");
	MakeCode	(x=0X101D70);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X101FB0,	"debugcmd_init_breakpoint");
	MakeCode	(x=0X102000);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(0X10201C);
	MakeComm	(0X102020,	"msg");
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X102048);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(x=0X10204C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X10204C,	"handle_queryhandle_packet");
	MakeCode	(x=0X102064);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X102090,	"handle");
	MakeCode	(x=0X102090);
	OpStkvar	(x,	1);
	MakeCode	(x=0X102098);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X10209C,	"count");
	MakeComm	(0X1020A4,	"src");
	MakeComm	(0X1020A8,	"dst");
	MakeComm	(0X1020B0,	"dst");
	MakeComm	(0X1020B4,	"src");
	MakeCode	(x=0X1020B4);
	OpStkvar	(x,	1);
	MakeComm	(0X1020B8,	"count");
	MakeComm	(0X1020BC,	"read 0x640 bytes at KProcessHandleTable");
	MakeComm	(0X1020DC,	"msg");
	MakeComm	(0X1020F4,	"msg");
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X10211C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X102120);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X102124);
	MakeName	(0X102124,	"handle_debugcmd_packet");
	MakeCode	(x=0X102128);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X102154,	"msg");
	MakeCode	(0X102178);
	MakeComm	(0X102180,	"msg");
	MakeCode	(0X1021A4);
	MakeComm	(0X1021AC,	"msg");
	MakeCode	(0X1021B8);
	MakeCode	(0X1021CC);
	MakeCode	(0X1021E0);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X1021F0);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X1021F4);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X1021F8);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(x=0X1021FC);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X1021FC,	"handle_reload_packet");
	MakeCode	(x=0X10220C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X102210,	"operation");
	MakeComm	(0X102220,	"sockfd");
	MakeComm	(0X102230,	"sockfd");
	MakeCode	(x=0X10223C);
	OpStkvar	(x,	1);
	MakeCode	(x=0X102240);
	OpStkvar	(x,	1);
	...
	MakeCode	(x=0X1022F4);
	OpStkvar	(x,	1);
	MakeComm	(0X1022F8,	"handle");
	MakeCode	(x=0X1022F8);
	OpStkvar	(x,	1);
	MakeComm	(0X1022FC,	"bytesRead");
	MakeCode	(x=0X1022FC);
	OpStkvar	(x,	1);
	MakeComm	(0X102304,	"offset");
	MakeComm	(0X102308,	"buffer");
	MakeComm	(0X102324,	"size");
	MakeComm	(0X102328,	"addr");
	MakeCode	(x=0X102328);
	OpStkvar	(x,	1);
	MakeComm	(0X102330,	"errno");
	MakeCode	(x=0X102338);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X10233C,	"v2");
	MakeCode	(x=0X102348);
	OpStkvar	(x,	1);
	MakeCode	(0X102354);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X102388);
	MakeName	(0X102388,	"handle_listprocess_packet");
	MakeCode	(x=0X102390);
	OpStkvar	(x,	1);
	...
	MakeComm	(0X1023B0,	"msg");
	MakeComm	(0X1023BC,	"a2");
	MakeCode	(x=0X1023BC);
	OpStkvar	(x,	1);
	MakeComm	(0X1023C0,	"processId");
	MakeComm	(0X1023C4,	"a3");
	MakeCode	(x=0X1023C4);
	OpStkvar	(x,	1);
	MakeComm	(0X1023C8,	"a4");
	MakeCode	(x=0X1023C8);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1023D8);
	OpOff		(x,	1,	0);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeDword	(x=0X102424);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X102428);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X10242C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X102434,	"handle_memlayout_packet");
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X102484,	"hKProcess");
	MakeCode	(x=0X102484);
	OpStkvar	(x,	1);
	MakeComm	(0X102488,	"addr");
	MakeComm	(0X10248C,	"size");
	MakeComm	(0X1024AC,	"msg");
	MakeComm	(0X1024D4,	"msg");
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X102500);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X102504);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X102508);
	MakeName	(0X102508,	"handle_writemem_packet");
	MakeCode	(x=0X10250C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X102530);
	...
	MakeComm	(0X102590,	"msg");
	MakeCode	(0X1025A0);
	MakeComm	(0X1025D4,	"dst");
	MakeComm	(0X1025D8,	"src");
	MakeComm	(0X1025DC,	"count");
	MakeCode	(0X1025FC);
	MakeCode	(0X102604);
	MakeComm	(0X102608,	"dst_addr");
	MakeComm	(0X102610,	"size");
	MakeCode	(x=0X102610);
	OpStkvar	(x,	1);
	MakeComm	(0X102614,	"hDst");
	MakeCode	(x=0X102614);
	OpStkvar	(x,	1);
	MakeComm	(0X102618,	"hSrc");
	MakeComm	(0X10261C,	"src_addr");
	MakeComm	(0X10262C,	"msg");
	MakeCode	(x=0X10263C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	OpOff		(x,	128,	0);
	MakeDword	(0X102668);
	MakeDword	(x=0X10266C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X102670);
	MakeName	(0X102670,	"hSrc");
	MakeDword	(x=0X102674);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X10267C);
	MakeName	(0X10267C,	"handle_readmem_packet");
	MakeCode	(x=0X102684);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X1026A8);
	...
	MakeComm	(0X1026FC,	"msg");
	MakeCode	(0X10270C);
	MakeComm	(0X102740,	"dst");
	MakeComm	(0X102744,	"src");
	MakeComm	(0X102748,	"count");
	MakeCode	(0X102758);
	MakeCode	(0X102760);
	MakeComm	(0X102764,	"size");
	MakeCode	(x=0X102764);
	OpStkvar	(x,	1);
	MakeComm	(0X10276C,	"dst_addr");
	MakeComm	(0X102770,	"hDst");
	MakeComm	(0X102774,	"hSrc");
	MakeCode	(x=0X102774);
	OpStkvar	(x,	1);
	MakeComm	(0X102778,	"src_addr");
	MakeComm	(0X102788,	"msg");
	MakeCode	(x=0X1027B4);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X1027E0);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X1027E4);
	MakeDword	(0X1027E8);
	MakeDword	(x=0X1027EC);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X1027F4);
	MakeName	(0X1027F4,	"get_remote_PC");
	MakeCode	(x=0X102804);
	OpStkvar	(x,	1);
	...
	MakeCode	(x=0X10285C);
	OpStkvar	(x,	1);
	MakeComm	(0X102860,	"context_struc");
	MakeComm	(0X102864,	"hProcess");
	MakeComm	(0X102868,	"tid");
	MakeCode	(x=0X102870);
	OpStkvar	(x,	1);
	MakeCode	(x=0X102874);
	OpStkvar	(x,	1);
	...
	MakeCode	(x=0X102948);
	OpStkvar	(x,	1);
	MakeComm	(0X10294C,	"msg");
	MakeCode	(x=0X10294C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(0X10296C);
	MakeDword	(x=0X10297C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X102980);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X10298C,	"handle_listthread_packet");
	MakeCode	(x=0X1029A4);
	OpStkvar	(x,	1);
	...
	MakeCode	(x=0X1029F0);
	OpStkvar	(x,	1);
	MakeComm	(0X1029F8,	"msg");
	MakeCode	(0X102A04);
	MakeComm	(0X102A08,	"msg");
	MakeComm	(0X102A1C,	"msg");
	MakeCode	(x=0X102A1C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	MakeCode	(x=0X102A30);
	OpStkvar	(x,	1);
	MakeComm	(0X102A40,	"msg");
	MakeComm	(0X102A5C,	"tid");
	MakeComm	(0X102A60,	"context_struc");
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X102AB0);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X102AB4);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X102AB8);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X102ABC);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X102AC4,	"inject_ntr_into_remote_process");
	MakeCode	(x=0X102AD4);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X102AE8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X102B00,	"msg");
	MakeCode	(0X102B0C);
	MakeComm	(0X102B10,	"addr");
	MakeComm	(0X102B14,	"handle");
	MakeComm	(0X102B18,	"size");
	MakeComm	(0X102B28,	"msg");
	MakeComm	(0X102B34,	"size");
	MakeComm	(0X102B38,	"hKProcess");
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X102B54,	"size");
	MakeCode	(x=0X102B54);
	OpStkvar	(x,	1);
	MakeComm	(0X102B58,	"hDst");
	MakeComm	(0X102B5C,	"hSrc");
	MakeComm	(0X102B60,	"dst_addr");
	MakeComm	(0X102B64,	"src_addr");
	MakeComm	(0X102B68,	"inject code into foreign process at addr 0x06005000");
	MakeComm	(0X102B8C,	"msg");
	MakeComm	(0X102BA4,	"hProcess");
	MakeComm	(0X102BA8,	"addr");
	MakeComm	(0X102BAC,	"size");
	MakeComm	(0X102BC0,	"dst addr");
	MakeComm	(0X102BD0,	"hDst");
	MakeComm	(0X102BD4,	"size");
	MakeCode	(x=0X102BD4);
	OpStkvar	(x,	1);
	MakeComm	(0X102BD8,	"hSrc");
	MakeComm	(0X102BDC,	"src_addr");
	MakeComm	(0X102BE0,	"back up two instructions at current PC");
	MakeComm	(0X102BF4,	"size");
	MakeCode	(x=0X102BF4);
	OpStkvar	(x,	1);
	MakeComm	(0X102BF8,	"save backed up PC at offs 0x28");
	MakeComm	(0X102BFC,	"hDst");
	MakeComm	(0X102C00,	"dst_addr");
	MakeCode	(x=0X102C00);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X102C04,	"hSrc");
	MakeComm	(0X102C08,	"src_addr");
	MakeComm	(0X102C0C,	"transfer backed up code and configuration to remote process\nat addr 0x06000000");
	MakeComm	(0X102C20,	"size");
	MakeCode	(x=0X102C20);
	OpStkvar	(x,	1);
	MakeCode	(x=0X102C24);
	OpStkvar	(x,	1);
	MakeComm	(0X102C2C,	"hDst");
	MakeCode	(x=0X102C30);
	OpStkvar	(x,	1);
	MakeComm	(0X102C34,	"dst_addr");
	MakeComm	(0X102C38,	"hSrc");
	MakeComm	(0X102C3C,	"src_addr");
	MakeCode	(x=0X102C3C);
	OpStkvar	(x,	1);
	MakeComm	(0X102C40,	"patch code at current PC to redirect code flow to addr 0x06005000");
	MakeComm	(0X102C4C,	"msg");
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X102C74);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X102C78);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X102C7C);
	...
	OpOff		(x,	128,	0);
	MakeDword	(0X102C84);
	MakeName	(0X102C84,	"dst_addr");
	MakeDword	(0X102C88);
	MakeDword	(x=0X102C8C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X102C90);
	MakeDword	(0X102C94);
	...
	MakeDword	(0X102C9C);
	MakeDword	(0X102CA0);
	MakeDword	(x=0X102CA4);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(x=0X102CA8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X102CA8,	"handle_attachprocess_packet");
	MakeCode	(x=0X102CC4);
	OpStkvar	(x,	1);
	...
	MakeCode	(x=0X102D08);
	OpStkvar	(x,	1);
	MakeComm	(0X102D10,	"addr_jmpcode");
	MakeCode	(0X102D10);
	MakeComm	(0X102D14,	"handle");
	MakeCode	(x=0X102D14);
	OpStkvar	(x,	1);
	MakeComm	(0X102D18,	"buf");
	MakeCode	(x=0X102D18);
	OpStkvar	(x,	1);
	MakeComm	(0X102D24,	"msg");
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X102D54);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X102D58);
	MakeName	(0X102D58,	"send_proc_context_to_client");
	MakeCode	(x=0X102D64);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X102D74,	"msg");
	MakeCode	(x=0X102D88);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X102DA0,	"msg");
	MakeCode	(x=0X102DA0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X102DBC);
	MakeName	(0X102DBC,	"check_for_bp_hit");
	MakeCode	(x=0X102DC0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X102E64);
	MakeName	(0X102E64,	"dispatch_client_cmd");
	MakeCode	(x=0X102E68);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X102E88,	"msg");
	ExtLinA		(0X102E88,	0,	"handle_hello_packet:");
	MakeCode	(0X102E94);
	ExtLinA		(0X102E9C,	0,	"handle_heartbeat_packet:");
	MakeCode	(x=0X102E9C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X102F98);
	MakeName	(0X102F98,	"handle_network_client");
	MakeComm	(0X102FA0,	"domain");
	MakeComm	(0X102FA4,	"type");
	MakeComm	(0X102FA8,	"protocol");
	MakeComm	(0X102FB8,	"nanoseconds");
	MakeCode	(x=0X102FC8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X102FD0);
	OpStkvar	(x,	1);
	MakeComm	(0X102FE8,	"addr");
	MakeComm	(0X102FEC,	"addrlen");
	MakeCode	(x=0X102FF0);
	OpStkvar	(x,	1);
	MakeCode	(x=0X102FF4);
	OpStkvar	(x,	1);
	MakeComm	(0X102FF8,	"sockfd");
	MakeComm	(0X10300C,	"max_connections");
	MakeComm	(0X103010,	"sockfd");
	MakeComm	(0X103018,	"errno");
	MakeComm	(0X103020,	"magic");
	MakeComm	(0X103028,	"fmt");
	MakeComm	(0X10302C,	"v2");
	MakeCode	(0X10303C);
	MakeComm	(0X103068,	"msg");
	MakeComm	(0X103074,	"sockfd");
	MakeComm	(0X103080,	"addr");
	MakeComm	(0X103084,	"sockfd");
	MakeComm	(0X103088,	"addrlen");
	MakeComm	(0X1030A4,	"nanoseconds");
	MakeCode	(0X1030B4);
	MakeDword	(0X1030D4);
	MakeName	(0X1030D4,	"p_some_code");
	MakeDword	(x=0X1030D8);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X1030DC);
	MakeDword	(0X1030E0);
	MakeDword	(x=0X1030E4);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X1030E8);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X1030EC);
	MakeCode	(0X1030F0);
	MakeName	(0X1030F0,	"thread_handle_network_client");
	MakeCode	(0X103100);
	MakeName	(0X103100,	"init_config_mem");
	MakeCode	(x=0X103104);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X103108);
	...
	MakeRptCmt	(0X103128,	"offset 0xC = 0x6000900");
	MakeComm	(0X103130,	"offs 0x10 = 0xF0");
	...
	OpOff		(x,	128,	0);
	MakeDword	(0X103154);
	MakeComm	(0X103158,	"operation");
	MakeCode	(0X103158);
	MakeName	(0X103158,	"ntrSetupNetworkDebugServer");
	...
	MakeComm	(0X1031C0,	"errno");
	MakeComm	(0X1031C8,	"fmt");
	MakeComm	(0X1031CC,	"v2");
	MakeCode	(x=0X1031D4);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X1031F4);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X103200,	"context_size");
	MakeComm	(0X103204,	"context_addr");
	MakeCode	(x=0X103204);
	OpStkvar	(x,	1);
	MakeCode	(x=0X103214);
	OpOff		(x,	1,	0);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X103274,	"*r6 = pid + 0x1388");
	...
	MakeComm	(0X103318,	"stacktop");
	MakeComm	(0X10331C,	"thread");
	MakeCode	(x=0X10331C);
	OpStkvar	(x,	1);
	MakeComm	(0X103324,	"errno");
	MakeCode	(x=0X10332C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X103330,	"v2");
	MakeDword	(0X103340);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X10336C);
	MakeName	(0X10336C,	"osConvertVaddr2Physaddr");
	MakeCode	(0X103380);
	MakeName	(0X103380,	"osConvertOldLinearMemToNew");
	MakeCode	(0X103394);
	MakeCode	(0X1033A8);
	MakeComm	(0X1033AC,	"processId");
	MakeComm	(0X1033B0,	"process");
	MakeCode	(x=0X1033B0);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1033B8);
	OpStkvar	(x,	1);
	...
	OpStkvar	(x,	1);
	MakeCode	(0X1033C8);
	MakeName	(0X1033C8,	"plgRegisterCallback");
	MakeCode	(x=0X1033D0);
	OpHex		(x,	1);
	MakeName	(0X1033D0,	"plgRequestMemory");
	MakeComm	(0X1033D4,	"operation");
	MakeCode	(x=0X1033E4);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1033EC,	"outaddr");
	MakeCode	(x=0X1033EC);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1033F4);
	OpOff		(x,	1,	0);
	...
	MakeDword	(0X103450);
	MakeCode	(0X103454);
	MakeName	(0X103454,	"plgGetSharedServiceHandle");
	MakeCode	(x=0X10345C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X10346C);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X103488);
	MakeName	(0X103488,	"plgGetIoBase");
	MakeCode	(x=0X10348C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X10349C);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X1034D0);
	MakeName	(0X1034D0,	"ntrResetKProcessRefcount");
	MakeCode	(x=0X1034D4);
	OpStkvar	(x,	1);
	MakeComm	(0X1034D8,	"processId");
	MakeComm	(0X1034E0,	"process");
	MakeCode	(x=0X1034E4);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1034F4,	"fmt");
	MakeComm	(0X1034F8,	"errno");
	MakeComm	(0X1034FC,	"v2");
	MakeComm	(0X103508,	"handle");
	MakeCode	(0X103508);
	MakeComm	(0X10350C,	"handle");
	MakeCode	(x=0X10350C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X103518,	"count");
	MakeComm	(0X103528,	"init var_14");
	...
	MakeCode	(x=0X103554);
	OpStkvar	(x,	1);
	MakeName	(0X103554,	"ntrSetHotkey");
	MakeCode	(x=0X10355C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X103560);
	...
	MakeCode	(x=0X103624);
	OpStkvar	(x,	1);
	MakeRptCmt	(0X103628,	"Set HotKey");
	MakeCode	(x=0X10362C);
	OpStkvar	(x,	1);
	MakeCode	(x=0X103630);
	OpOff		(x,	1,	0);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X10375C);
	MakeName	(0X10375C,	"plgRegisterMenuEntry");
	MakeCode	(x=0X103760);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X103764);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeComm	(0X1037A4,	"operation");
	MakeCode	(0X1037A4);
	MakeName	(0X1037A4,	"ntrAllocPluginMemory");
	MakeCode	(x=0X1037A8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X1037AC);
	...
	OpOff		(x,	1,	0X10AED8);
	OpOff		(x,	129,	0X10AED8);
	MakeComm	(0X1037DC,	"msg");
	MakeComm	(0X1037EC,	"outaddr");
	MakeCode	(x=0X1037EC);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X103850);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X103854);
	MakeDword	(0X103858);
	MakeName	(0X103858,	"hProcess");
	MakeDword	(x=0X10385C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X103860);
	MakeName	(0X103860,	"ntrGetFSUserHandle");
	MakeCode	(x=0X103864);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X103874);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X103890,	"handleptr");
	MakeComm	(0X103898,	"handle");
	MakeComm	(0X1038A8,	"msg");
	MakeComm	(0X1038B4,	"msg");
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X1038D0);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X1038D4);
	MakeName	(0X1038D4,	"inject_into_nintendo_home");
	MakeCode	(x=0X1038DC);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X1038E8);
	...
	MakeComm	(0X1038FC,	"pid 15 = \"menu\" process?");
	MakeCode	(x=0X103908);
	OpOff		(x,	1,	0X10AED8);
	OpOff		(x,	129,	0X10AED8);
	MakeComm	(0X103914,	"msg");
	MakeCode	(x=0X10391C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X10392C);
	...
	MakeCode	(x=0X103934);
	OpStkvar	(x,	1);
	MakeComm	(0X10393C,	"size");
	MakeCode	(x=0X10393C);
	OpStkvar	(x,	1);
	MakeComm	(0X103940,	"hDst");
	MakeComm	(0X103944,	"dst_addr");
	MakeComm	(0X103948,	"hSrc");
	MakeComm	(0X10394C,	"src_addr");
	MakeCode	(x=0X10394C);
	OpOff		(x,	1,	0X1085F4);
	OpOff		(x,	129,	0X1085F4);
	MakeCode	(x=0X103958);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X103960,	"buf");
	MakeComm	(0X103964,	"handle");
	MakeCode	(x=0X10396C);
	OpStkvar	(x,	1);
	MakeCode	(x=0X103970);
	OpOff		(x,	1,	0);
	...
	MakeCode	(0X103A0C);
	MakeCode	(0X103A1C);
	MakeComm	(0X103A44,	"handle");
	MakeCode	(0X103A44);
	MakeComm	(0X103A48,	"addr");
	MakeCode	(x=0X103A48);
	OpOff		(x,	1,	0X1085F4);
	OpOff		(x,	129,	0X1085F4);
	MakeComm	(0X103A4C,	"size");
	MakeCode	(x=0X103A54);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	MakeComm	(0X103A84,	"size");
	MakeCode	(x=0X103A84);
	OpStkvar	(x,	1);
	MakeComm	(0X103A88,	"hDst");
	MakeComm	(0X103A8C,	"dst_addr");
	MakeCode	(x=0X103A8C);
	OpOff		(x,	1,	0X1085F4);
	OpOff		(x,	129,	0X1085F4);
	MakeComm	(0X103A90,	"hSrc");
	MakeComm	(0X103A94,	"src_addr");
	MakeCode	(x=0X103AAC);
	OpStkvar	(x,	1);
	MakeComm	(0X103AC0,	"hDst");
	MakeComm	(0X103AC8,	"size");
	MakeCode	(x=0X103AC8);
	OpStkvar	(x,	1);
	MakeComm	(0X103ACC,	"dst_addr");
	MakeComm	(0X103AD0,	"src_addr");
	MakeComm	(0X103AD4,	"hSrc");
	MakeCode	(x=0X103AE8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X103AF0,	"handle");
	MakeCode	(0X103AF0);
	MakeComm	(0X103AF4,	"addr_jmpcode");
	MakeComm	(0X103AF8,	"buf");
	MakeCode	(x=0X103AF8);
	OpStkvar	(x,	1);
	MakeComm	(0X103B08,	"msg");
	MakeCode	(0X103B18);
	MakeCode	(0X103B20);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X103B64);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X103B68);
	MakeName	(0X103B68,	"callback_inject_into_nintendo_home");
	MakeCode	(x=0X103B80);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X103BF4,	"install_home_injection_hook");
	MakeCode	(x=0X103BFC);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X103C00,	"funcaddr");
	MakeComm	(0X103C04,	"hook");
	MakeComm	(0X103C08,	"callback_addr");
	MakeCode	(x=0X103C08);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X103C10,	"rthook");
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X103C28);
	MakeName	(0X103C28,	"find_files?");
	MakeComm	(0X103C30,	"archive");
	MakeComm	(0X103C3C,	"a1");
	MakeCode	(x=0X103C48);
	OpStkvar	(x,	1);
	MakeCode	(x=0X103C50);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X103D30);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(x=0X103D34);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X103D34,	"update_plginfo_with_arm11_addresses");
	MakeCode	(x=0X103D44);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X103D4C);
	...
	MakeCode	(0X103D7C);
	MakeCode	(0X103D80);
	MakeName	(0X103D80,	"load_ntr_plugins");
	MakeCode	(x=0X103D90);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X103D94,	"buff");
	MakeCode	(x=0X103D94);
	OpStkvar	(x,	1);
	MakeCode	(x=0X103DA0);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X103DC0,	"fmt");
	MakeCode	(x=0X103DC4);
	OpStkvar	(x,	1);
	MakeComm	(0X103DCC,	"buff");
	MakeCode	(x=0X103DCC);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X103E80);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X103E84);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X103E88);
	MakeDword	(x=0X103E8C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X103E94);
	MakeName	(0X103E94,	"callback_applet_start");
	MakeCode	(x=0X103EB0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X103ECC,	"buff");
	MakeCode	(x=0X103ED0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X103EE0);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X103F28,	"inject_ntr_into_process_manager");
	MakeCode	(x=0X103F3C);
	OpStkvar	(x,	1);
	MakeComm	(0X103F4C,	"pid 2");
	...
	MakeCode	(x=0X103F74);
	OpStkvar	(x,	1);
	MakeComm	(0X103F7C,	"handle");
	MakeCode	(x=0X103F7C);
	OpStkvar	(x,	1);
	MakeComm	(0X103F80,	"addr_jmpcode");
	MakeComm	(0X103F84,	"buf");
	MakeCode	(x=0X103F84);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X103FAC);
	MakeName	(0X103FAC,	"init_all_plugins_0");
	MakeCode	(x=0X103FB0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X103FB4);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X103FE4,	"msg");
	MakeCode	(0X103FF0);
	MakeComm	(0X104008,	"msg");
	MakeCode	(0X10402C);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X10403C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X104040);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X104044);
	MakeName	(0X104044,	"load_all_plugins_and_inject_ntr_into_pm");
	MakeCode	(x=0X104048);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X10404C);
	...
	OpOff		(x,	1,	0X10AED8);
	OpOff		(x,	129,	0X10AED8);
	MakeComm	(0X1040E0,	"size");
	MakeCode	(x=0X1040F0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1040F8,	"fileName");
	MakeComm	(0X1040FC,	"pBuf");
	MakeComm	(0X104100,	"arm11 binsize");
	MakeCode	(x=0X104108);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X104114);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X104178,	"callback_addr");
	MakeCode	(x=0X104178);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X10417C,	"funcaddr");
	MakeComm	(0X104184,	"rthook");
	MakeCode	(x=0X104184);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X1041D8);
	MakeName	(0X1041D8,	"init_all_plugins");
	MakeCode	(x=0X1041E0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X1041E4);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X104240);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X104244);
	MakeCode	(0X104248);
	MakeName	(0X104248,	"ntrGetCurrentProcessId");
	MakeCode	(x=0X10424C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	MakeDword	(0X104268);
	MakeName	(0X104268,	"handle");
	MakeCode	(0X10426C);
	MakeName	(0X10426C,	"ntrGetCurrentProcessHandle");
	MakeCode	(x=0X104274);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X104278);
	...
	MakeCode	(x=0X104298);
	OpStkvar	(x,	1);
	MakeComm	(0X1042A0,	"errno");
	MakeCode	(x=0X1042A4);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1042A8);
	OpOff		(x,	1,	0X10B480);
	OpOff		(x,	129,	0X10B480);
	MakeComm	(0X1042B0,	"fmt");
	MakeComm	(0X1042B4,	"v2");
	MakeDword	(x=0X1042C8);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X1042CC);
	MakeDword	(x=0X1042D0);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X1042D4);
	MakeCode	(0X1042D8);
	MakeName	(0X1042D8,	"controlRemoteMemory");
	MakeComm	(0X1042DC,	"operation");
	MakeCode	(x=0X1042E0);
	OpStkvar	(x,	1);
	MakeComm	(0X104314,	"outaddr");
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X10434C,	"errno");
	MakeCode	(x=0X10434C);
	OpStkvar	(x,	1);
	MakeComm	(0X104358,	"fmt");
	MakeComm	(0X10435C,	"v2");
	MakeDword	(0X104370);
	MakeDword	(x=0X104374);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X104378);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeComm	(0X10437C,	"Type");
	MakeCode	(0X10437C);
	MakeName	(0X10437C,	"ntrProtectRemoteMemory");
	MakeComm	(0X104380,	"Size");
	MakeComm	(0X104384,	"permissions");
	MakeComm	(0X104388,	"type");
	MakeComm	(0X104390,	"Addr1");
	MakeCode	(x=0X10439C);
	OpStkvar	(x,	1);
	MakeCode	(0X1043A0);
	MakeName	(0X1043A0,	"ntrProtectMemory");
	MakeComm	(0X1043B0,	"addr");
	MakeComm	(0X1043B4,	"size");
	MakeCode	(0X1043C0);
	MakeName	(0X1043C0,	"inter_process_dma_copy");
	MakeCode	(x=0X1043C8);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1043CC);
	OpStkvar	(x,	1);
	MakeComm	(0X1043F4,	"process");
	MakeComm	(0X1043F8,	"addr");
	MakeComm	(0X1043FC,	"size");
	MakeCode	(x=0X104400);
	OpStkvar	(x,	1);
	MakeComm	(0X104414,	"process");
	...
	MakeCode	(x=0X104444);
	OpStkvar	(x,	1);
	MakeComm	(0X104448,	"hdstProcess");
	MakeComm	(0X10444C,	"dst");
	MakeComm	(0X104450,	"hsrcProcess");
	...
	MakeCode	(x=0X1044AC);
	OpHex		(x,	1);
	MakeComm	(0X1044B8,	"nanoseconds");
	MakeComm	(0X1044CC,	"fmt");
	MakeComm	(0X1044D0,	"errno");
	MakeCode	(x=0X1044D0);
	OpStkvar	(x,	1);
	MakeComm	(0X1044D4,	"v2");
	MakeComm	(0X1044E4,	"handle");
	MakeCode	(x=0X1044E4);
	OpStkvar	(x,	1);
	MakeComm	(0X1044EC,	"process");
	...
	MakeDword	(0X104518);
	MakeDword	(0X10451C);
	MakeDword	(x=0X104520);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X104524);
	MakeComm	(0X104534,	"count");
	MakeComm	(0X104538,	"src");
	MakeComm	(0X10453C,	"dst");
	MakeCode	(x=0X104544);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X104548,	"dst");
	MakeCode	(x=0X104548);
	OpStkvar	(x,	1);
	MakeComm	(0X10454C,	"count");
	MakeComm	(0X104554,	"src");
	MakeCode	(x=0X10455C);
	OpStkvar	(x,	1);
	MakeCode	(x=0X104564);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X104578);
	MakeName	(0X104578,	"get_process_name");
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1045B8,	"handle");
	MakeCode	(x=0X1045B8);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1045C0);
	OpStkvar	(x,	1);
	MakeComm	(0X1045C4,	"count");
	MakeComm	(0X1045CC,	"src");
	MakeComm	(0X1045D0,	"dst");
	MakeCode	(x=0X1045D8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1045DC,	"dst");
	MakeCode	(x=0X1045DC);
	OpStkvar	(x,	1);
	MakeComm	(0X1045E0,	"count");
	MakeComm	(0X1045E8,	"src");
	MakeCode	(x=0X1045F0);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1045FC);
	OpStkvar	(x,	1);
	...
	MakeCode	(x=0X1046E4);
	OpStkvar	(x,	1);
	MakeComm	(0X1046EC,	"fmt");
	MakeCode	(x=0X1046EC);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1046F4,	"buff");
	MakeComm	(0X104714,	"hKProcess");
	MakeCode	(x=0X104714);
	OpStkvar	(x,	1);
	MakeComm	(0X104718,	"addr");
	MakeComm	(0X10471C,	"size");
	MakeComm	(0X104730,	"fmt");
	MakeComm	(0X104734,	"errno");
	MakeComm	(0X104738,	"v2");
	MakeComm	(0X104740,	"handle");
	MakeCode	(x=0X104740);
	OpStkvar	(x,	1);
	MakeCode	(0X104754);
	MakeComm	(0X104758,	"size");
	MakeCode	(x=0X104758);
	OpStkvar	(x,	1);
	MakeComm	(0X10475C,	"dst_addr");
	MakeComm	(0X104760,	"hDst");
	MakeComm	(0X104764,	"hSrc");
	MakeCode	(x=0X104764);
	OpStkvar	(x,	1);
	MakeComm	(0X104768,	"src_addr");
	MakeComm	(0X104770,	"errno");
	MakeComm	(0X104778,	"fmt");
	MakeComm	(0X10477C,	"v2");
	MakeComm	(0X10478C,	"size");
	MakeCode	(x=0X10478C);
	OpStkvar	(x,	1);
	MakeComm	(0X104794,	"handle");
	MakeCode	(x=0X104794);
	OpStkvar	(x,	1);
	MakeComm	(0X104798,	"bytesWritten");
	MakeComm	(0X10479C,	"offset");
	MakeComm	(0X1047A0,	"buffer");
	...
	OpOff		(x,	128,	0);
	MakeDword	(0X1047E0);
	MakeDword	(x=0X1047E4);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X1047E8);
	MakeDword	(x=0X1047EC);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X1047F0);
	MakeComm	(0X1047F8,	"archive");
	MakeCode	(x=0X104810);
	OpStkvar	(x,	1);
	MakeCode	(x=0X104814);
	OpStkvar	(x,	1);
	...
	MakeCode	(x=0X104834);
	OpStkvar	(x,	1);
	MakeComm	(0X104844,	"openflags");
	MakeCode	(x=0X104844);
	OpStkvar	(x,	1);
	MakeComm	(0X10484C,	"attributes");
	MakeCode	(x=0X10484C);
	OpStkvar	(x,	1);
	MakeCode	(x=0X104858);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X104860,	"handle");
	MakeComm	(0X104864,	"out");
	MakeCode	(x=0X104864);
	OpStkvar	(x,	1);
	MakeCode	(x=0X104870);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X104880,	"fmt");
	MakeComm	(0X104884,	"errno");
	MakeCode	(x=0X104884);
	OpStkvar	(x,	1);
	MakeComm	(0X104888,	"v2");
	MakeComm	(0X104890,	"handle_out");
	MakeCode	(x=0X104890);
	OpStkvar	(x,	1);
	MakeComm	(0X104894,	"pid");
	MakeComm	(0X1048B0,	"fmt");
	MakeComm	(0X1048B4,	"errno");
	MakeCode	(x=0X1048B4);
	OpStkvar	(x,	1);
	MakeComm	(0X1048B8,	"v2");
	MakeCode	(x=0X1048C0);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1048C4);
	OpStkvar	(x,	1);
	MakeComm	(0X1048D0,	"buff");
	MakeComm	(0X1048D4,	"fmt");
	MakeCode	(x=0X1048D4);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1048E0,	"x");
	...
	MakeComm	(0X1048F4,	"s");
	MakeComm	(0X1048F8,	"r");
	MakeComm	(0X104904,	"addr");
	MakeComm	(0X104908,	"buffer");
	MakeComm	(0X10490C,	"debug");
	MakeCode	(x=0X10490C);
	OpStkvar	(x,	1);
	MakeComm	(0X104910,	"size");
	MakeComm	(0X104918,	"v2");
	MakeCode	(x=0X104920);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X104924,	"errno");
	MakeComm	(0X10492C,	"handle");
	MakeCode	(x=0X10492C);
	OpStkvar	(x,	1);
	MakeCode	(0X104940);
	MakeComm	(0X104944,	"flushFlags");
	MakeCode	(x=0X104944);
	OpStkvar	(x,	1);
	MakeCode	(x=0X104948);
	OpStkvar	(x,	1);
	MakeComm	(0X10494C,	"size");
	MakeCode	(x=0X10494C);
	OpStkvar	(x,	1);
	MakeComm	(0X104950,	"offset");
	MakeComm	(0X104954,	"handle");
	MakeCode	(x=0X104954);
	OpStkvar	(x,	1);
	MakeComm	(0X104958,	"bytesWritten");
	MakeComm	(0X10495C,	"data");
	MakeComm	(0X10496C,	"handle");
	MakeCode	(x=0X10496C);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X104994);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X104998);
	MakeDword	(x=0X10499C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X1049A8);
	MakeName	(0X1049A8,	"dumpMemoryToFile");
	MakeComm	(0X1049AC,	"flushFlags");
	MakeComm	(0X1049B0,	"archive");
	MakeCode	(x=0X1049B4);
	OpStkvar	(x,	1);
	MakeComm	(0X1049C4,	"msg");
	MakeComm	(0X1049DC,	"a1");
	MakeCode	(x=0X1049F4);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X104A00);
	...
	MakeCode	(x=0X104A34);
	OpStkvar	(x,	1);
	MakeComm	(0X104A3C,	"msg");
	MakeCode	(x=0X104A4C);
	OpStkvar	(x,	1);
	MakeCode	(x=0X104A58);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X104A64,	"dst");
	MakeCode	(0X104A64);
	MakeComm	(0X104A68,	"src");
	MakeComm	(0X104A6C,	"count");
	MakeComm	(0X104A7C,	"size");
	MakeCode	(x=0X104A7C);
	OpStkvar	(x,	1);
	MakeComm	(0X104A84,	"bytesWritten");
	MakeCode	(x=0X104A84);
	OpStkvar	(x,	1);
	MakeComm	(0X104A88,	"offset");
	MakeComm	(0X104A8C,	"handle");
	MakeComm	(0X104A90,	"buffer");
	MakeComm	(0X104AA8,	"buff");
	MakeComm	(0X104AAC,	"fmt");
	MakeCode	(x=0X104AAC);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(0X104AE0);
	MakeDword	(x=0X104AEC);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	...
	MakeComm	(0X104B58,	"size");
	MakeCode	(x=0X104B58);
	OpStkvar	(x,	1);
	MakeComm	(0X104B5C,	"hDst");
	MakeCode	(x=0X104B5C);
	OpStkvar	(x,	1);
	MakeComm	(0X104B60,	"dst_addr");
	MakeComm	(0X104B64,	"hSrc");
	MakeComm	(0X104B68,	"src_addr");
	MakeComm	(0X104B74,	"handle");
	MakeCode	(x=0X104B74);
	OpStkvar	(x,	1);
	MakeDword	(0X104B90);
	MakeCode	(0X104B94);
	MakeName	(0X104B94,	"patch_sm");
	MakeCode	(x=0X104B9C);
	OpStkvar	(x,	1);
	MakeComm	(0X104BBC,	"errno");
	MakeComm	(0X104BC4,	"fmt");
	MakeComm	(0X104BC8,	"v2");
	MakeCode	(x=0X104BD4);
	OpStkvar	(x,	1);
	MakeDword	(0X104BD8);
	MakeDword	(0X104BDC);
	MakeDword	(0X104BE0);
	MakeDword	(x=0X104BE4);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X104BE8);
	MakeName	(0X104BE8,	"ntrProcessManager");
	MakeCode	(x=0X104BF4);
	OpStkvar	(x,	1);
	MakeCode	(x=0X104BF8);
	OpStkvar	(x,	1);
	...
	MakeCode	(x=0X104C0C);
	OpStkvar	(x,	1);
	MakeComm	(0X104C14,	"errno");
	MakeCode	(x=0X104C1C);
	OpStkvar	(x,	1);
	MakeComm	(0X104C28,	"fmt");
	MakeComm	(0X104C2C,	"v2");
	MakeCode	(x=0X104C38);
	OpStkvar	(x,	1);
	MakeCode	(x=0X104C3C);
	OpStkvar	(x,	1);
	MakeComm	(0X104C4C,	"buff");
	MakeCode	(x=0X104C4C);
	OpStkvar	(x,	1);
	MakeComm	(0X104C50,	"fmt");
	MakeCode	(x=0X104C58);
	OpStkvar	(x,	1);
	MakeCode	(x=0X104C60);
	OpStkvar	(x,	1);
	MakeComm	(0X104C6C,	"a1");
	MakeCode	(x=0X104C6C);
	OpStkvar	(x,	1);
	MakeCode	(x=0X104C84);
	OpOff		(x,	1,	0);
	...
	MakeComm	(0X104CD0,	"buff");
	MakeCode	(x=0X104CD0);
	OpStkvar	(x,	1);
	MakeComm	(0X104CD4,	"fmt");
	MakeComm	(0X104CE0,	"pid");
	MakeComm	(0X104CE4,	"filename");
	MakeCode	(x=0X104CE4);
	OpStkvar	(x,	1);
	MakeCode	(0X104CF0);
	MakeComm	(0X104CFC,	"a2");
	MakeCode	(x=0X104CFC);
	OpStkvar	(x,	1);
	MakeComm	(0X104D00,	"a3");
	MakeCode	(x=0X104D00);
	OpStkvar	(x,	1);
	MakeComm	(0X104D04,	"processId");
	MakeComm	(0X104D08,	"a4");
	MakeCode	(x=0X104D0C);
	OpStkvar	(x,	1);
	MakeComm	(0X104D14,	"fmt");
	MakeComm	(0X104D18,	"errno");
	MakeCode	(x=0X104D18);
	OpStkvar	(x,	1);
	MakeComm	(0X104D1C,	"v2");
	MakeCode	(0X104D28);
	MakeDword	(x=0X104D34);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X104D38);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X104D44);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X104D48);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X104D4C);
	...
	MakeDword	(0X104E60);
	MakeCode	(0X104E64);
	MakeName	(0X104E64,	"recv?");
	MakeComm	(0X104E84,	"sockfd");
	MakeComm	(0X104E88,	"buf");
	MakeComm	(0X104E8C,	"len");
	MakeComm	(0X104E90,	"flags");
	MakeCode	(0X104EAC);
	MakeCode	(0X104EB8);
	MakeCode	(0X104EC0);
	MakeComm	(0X104EE0,	"sockfd");
	MakeComm	(0X104EE4,	"buf");
	MakeComm	(0X104EE8,	"len");
	MakeComm	(0X104EEC,	"flags");
	MakeCode	(0X104F04);
	MakeCode	(0X104F10);
	MakeCode	(0X104F18);
	MakeCode	(x=0X104F20);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X105018);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X10501C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X105020);
	...
	MakeCode	(x=0X1050DC);
	OpStkvar	(x,	1);
	MakeComm	(0X1050E8,	"msg");
	MakeComm	(0X1050F8,	"size");
	MakeCode	(x=0X1050F8);
	OpStkvar	(x,	1);
	MakeComm	(0X1050FC,	"size");
	MakeCode	(x=0X1050FC);
	OpStkvar	(x,	1);
	MakeComm	(0X105100,	"handle");
	MakeCode	(x=0X105100);
	OpStkvar	(x,	1);
	MakeComm	(0X105104,	"bytesRead");
	MakeCode	(x=0X105104);
	OpStkvar	(x,	1);
	MakeComm	(0X105108,	"offset");
	MakeComm	(0X10510C,	"buffer");
	MakeComm	(0X10511C,	"msg");
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X105158);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X10515C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X105160);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X105164);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X105168);
	...
	MakeComm	(0X105190,	"msg");
	MakeComm	(0X1051A4,	"handle");
	MakeCode	(x=0X1051A4);
	OpStkvar	(x,	1);
	MakeComm	(0X1051AC,	"count");
	MakeComm	(0X1051B0,	"src");
	MakeComm	(0X1051B4,	"dst");
	MakeComm	(0X1051B8,	"get first 0xA0 bytes of KThread object");
	MakeComm	(0X1051BC,	"end address of the page for this thread");
	MakeComm	(0X1051C0,	"dst");
	MakeComm	(0X1051C4,	"src");
	MakeComm	(0X1051C8,	"get very last 0x10C number of bytes of the end address");
	MakeComm	(0X1051D0,	"handle");
	MakeCode	(x=0X1051D0);
	OpStkvar	(x,	1);
	MakeDword	(x=0X1051E4);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X1051E8);
	MakeName	(0X1051E8,	"rtGenerateJumpCode");
	MakeDword	(0X1051FC);
	MakeName	(0X1051FC,	"LDR_PC_PC_MINUS_4");
	MakeCode	(0X105200);
	MakeName	(0X105200,	"rtFlushInstructionCache");
	MakeComm	(0X105204,	"size");
	MakeComm	(0X105208,	"process");
	MakeComm	(0X10520C,	"addr");
	MakeDword	(0X105214);
	MakeName	(0X105214,	"process");
	MakeCode	(0X105218);
	MakeName	(0X105218,	"rtInitHook");
	MakeComm	(0X105238,	"addr");
	MakeComm	(0X10523C,	"size");
	MakeComm	(0X105248,	"ldr pc, [pc-4]");
	MakeComm	(0X105264,	"addr");
	MakeComm	(0X105280,	"size");
	MakeDword	(0X10528C);
	MakeCode	(0X105290);
	MakeName	(0X105290,	"rtEnableHook");
	MakeComm	(0X1052A8,	"get patch addr");
	MakeComm	(0X1052AC,	"get code: ldr pc, [pc-4]");
	MakeComm	(0X1052B0,	"place jmp");
	MakeComm	(0X1052B8,	"place target addr");
	MakeComm	(0X1052BC,	"size");
	MakeComm	(0X1052C0,	"addr");
	MakeCode	(0X1052D4);
	MakeName	(0X1052D4,	"rtDisableHook");
	MakeComm	(0X105300,	"size");
	MakeComm	(0X105304,	"addr");
	MakeCode	(0X105318);
	MakeName	(0X105318,	"ntrFileCreate");
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X105398);
	MakeName	(0X105398,	"ntrFileRead");
	MakeComm	(0X10539C,	"size");
	MakeComm	(0X1053AC,	"bytesRead");
	MakeCode	(x=0X1053AC);
	OpStkvar	(x,	1);
	MakeComm	(0X1053B0,	"offset");
	MakeComm	(0X1053B4,	"buffer");
	MakeCode	(x=0X1053C0);
	OpStkvar	(x,	1);
	MakeCode	(0X1053CC);
	MakeName	(0X1053CC,	"ntrFileWrite");
	MakeComm	(0X1053D0,	"size");
	MakeComm	(0X1053E4,	"flushFlags");
	MakeCode	(x=0X1053E4);
	OpStkvar	(x,	1);
	MakeComm	(0X1053E8,	"bytesWritten");
	MakeCode	(x=0X1053E8);
	OpStkvar	(x,	1);
	MakeComm	(0X1053EC,	"offset");
	MakeComm	(0X1053F0,	"buffer");
	MakeCode	(x=0X1053FC);
	OpStkvar	(x,	1);
	MakeCode	(0X105408);
	MakeName	(0X105408,	"ntrFileClose");
	MakeCode	(0X10540C);
	MakeName	(0X10540C,	"ntrU32ToU8Array");
	MakeCode	(0X10542C);
	MakeName	(0X10542C,	"ntrU16ToU8Array");
	MakeComm	(0X10543C,	"flushFlags");
	MakeCode	(0X10543C);
	MakeName	(0X10543C,	"ntrScreenShotSaveFile");
	MakeRptCmt	(0X105444,	"Header Length");
	MakeComm	(0X10547C,	"array");
	MakeComm	(0X105480,	"number");
	MakeComm	(0X105498,	"array");
	MakeComm	(0X10549C,	"number");
	MakeComm	(0X1054BC,	"array");
	MakeComm	(0X1054C0,	"number");
	MakeComm	(0X1054D4,	"number");
	MakeComm	(0X1054DC,	"array");
	MakeComm	(0X105514,	"filename");
	MakeComm	(0X105518,	"mode");
	MakeComm	(0X105528,	"offset");
	MakeComm	(0X10552C,	"buffer");
	MakeComm	(0X105530,	"size");
	MakeComm	(0X105538,	"handle");
	MakeCode	(0X105544);
	MakeName	(0X105544,	"ntrScreenShotCopyImageAsBMP");
	MakeCode	(x=0X105548);
	OpStkvar	(x,	1);
	MakeCode	(x=0X10554C);
	OpStkvar	(x,	1);
	...
	MakeCode	(0X105670);
	MakeCode	(0X105674);
	MakeName	(0X105674,	"ntrScreenShotGetIndex");
	MakeComm	(0X105680,	"buff");
	MakeCode	(x=0X105684);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X105690,	"filename");
	MakeComm	(0X105694,	"mode");
	MakeCode	(0X1056B0);
	MakeDword	(x=0X1056BC);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X1056C0);
	MakeName	(0X1056C0,	"display_OSD_menu");
	MakeCode	(x=0X1056C8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1056D8,	"size");
	MakeCode	(x=0X1056E8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X1056F8);
	...
	MakeCode	(x=0X105758);
	OpStkvar	(x,	1);
	MakeComm	(0X105760,	"count");
	MakeComm	(0X105764,	"src");
	MakeCode	(x=0X105770);
	OpStkvar	(x,	1);
	MakeCode	(x=0X105774);
	OpOff		(x,	1,	0);
	...
	MakeCode	(x=0X105788);
	OpStkvar	(x,	1);
	MakeComm	(0X105790,	"buff");
	MakeCode	(x=0X105790);
	OpStkvar	(x,	1);
	MakeCode	(x=0X105794);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1057A0,	"buffer");
	MakeComm	(0X1057A4,	"width");
	MakeComm	(0X1057A8,	"height");
	MakeComm	(0X1057AC,	"filename");
	MakeCode	(x=0X1057AC);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1057B8);
	OpStkvar	(x,	1);
	MakeComm	(0X1057C4,	"dst");
	MakeCode	(x=0X1057C8);
	OpHex		(x,	1);
	MakeComm	(0X1057D0,	"count");
	MakeComm	(0X1057D4,	"src");
	MakeCode	(x=0X1057F0);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1057F4);
	OpStkvar	(x,	1);
	MakeComm	(0X1057FC,	"buff");
	MakeCode	(x=0X1057FC);
	OpStkvar	(x,	1);
	MakeComm	(0X105800,	"fmt");
	MakeComm	(0X10580C,	"filename");
	MakeCode	(x=0X10580C);
	OpStkvar	(x,	1);
	MakeComm	(0X105810,	"buffer");
	MakeComm	(0X105814,	"width");
	MakeComm	(0X105818,	"height");
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X105858);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X10585C);
	MakeDword	(0X105860);
	MakeName	(0X105860,	"ntrCreateScreenShotCallback");
	MakeCode	(0X105864);
	MakeCode	(x=0X105868);
	OpStkvar	(x,	1);
	MakeCode	(x=0X10586C);
	...
	MakeCode	(x=0X105874);
	OpStkvar	(x,	1);
	MakeComm	(0X105880,	"arg1");
	MakeComm	(0X105884,	"arg2");
	MakeComm	(0X105888,	"arg3");
	MakeComm	(0X10588C,	"cmd");
	MakeComm	(0X105894,	"ns");
	MakeComm	(0X1058A4,	"arg1");
	MakeComm	(0X1058A8,	"arg2");
	MakeComm	(0X1058AC,	"arg3");
	MakeComm	(0X1058B0,	"cmd");
	MakeCode	(x=0X1058C0);
	OpStkvar	(x,	1);
	MakeDword	(0X1058C4);
	MakeCode	(0X1058C8);
	MakeName	(0X1058C8,	"ntrScreenShotBuiltinPluginInit");
	MakeComm	(0X1058CC,	"msg");
	MakeCode	(x=0X1058D0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1058D8,	"callback");
	MakeCode	(x=0X1058D8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1058DC,	"title");
	MakeComm	(0X1058E0,	"catalog");
	MakeComm	(0X1058E8,	"handle");
	MakeCode	(x=0X1058EC);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1058F8,	"msg");
	MakeCode	(x=0X105904);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X105910,	"msg");
	MakeDword	(x=0X10591C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeName	(0X105924,	"callback");
	MakeDword	(x=0X105928);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X10592C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeName	(0X10592C,	"servName");
	MakeDword	(x=0X105930);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X105934);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(x=0X105938);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(x=0X10593C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X10593C,	"ntrPlgInitSharedFunctions");
	MakeCode	(x=0X105940);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X10594C);
...
#define id x
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X1059B8);
	MakeName	(0X1059B8,	"socketNetConvertError");
	MakeCode	(x=0X1059C8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(0X1059E8);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X105A80);
	MakeName	(0X105A80,	"socketInitialize");
	MakeCode	(x=0X105A88);
	OpStkvar	(x,	1);
	MakeComm	(0X105A8C,	"mypermission");
	MakeComm	(0X105A9C,	"otherpermission");
	MakeCode	(x=0X105A9C);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X105ACC,	"memhandle");
	MakeCode	(x=0X105ACC);
	OpStkvar	(x,	1);
	MakeComm	(0X105AD0,	"memsize");
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X105AE8,	"socketGetErrno");
	MakeCode	(x=0X105AEC);
	OpOff		(x,	1,	0X10B490);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X105AF8);
	MakeName	(0X105AF8,	"socketOpen");
	MakeCode	(x=0X105B14);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X105B2C,	"session");
	MakeComm	(0X105B4C,	"sock_retval");
	MakeCode	(0X105B58);
	MakeDword	(0X105B60);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X105B68);
	MakeName	(0X105B68,	"socketClose");
	MakeCode	(x=0X105B7C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X105B8C,	"session");
	MakeComm	(0X105BA8,	"sock_retval");
	MakeDword	(0X105BC0);
	MakeDword	(x=0X105BC4);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X105BC8);
	MakeName	(0X105BC8,	"socketShutdown");
	MakeCode	(x=0X105BE0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X105BF4,	"session");
	MakeComm	(0X105C10,	"sock_retval");
	MakeDword	(0X105C28);
	MakeDword	(x=0X105C2C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X105C30);
	MakeName	(0X105C30,	"socketListen");
	MakeCode	(x=0X105C48);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X105C5C,	"session");
	MakeComm	(0X105C78,	"sock_retval");
	MakeDword	(0X105C90);
	MakeDword	(x=0X105C94);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X105C98);
	MakeName	(0X105C98,	"socketAccept");
	MakeCode	(x=0X105CB0);
	OpStkvar	(x,	1);
	MakeCode	(x=0X105CE0);
	OpOff		(x,	1,	0);
	...
	MakeComm	(0X105E4C,	"sock_retval");
	MakeDword	(x=0X105E64);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X105E68);
	MakeCode	(0X105E6C);
	MakeName	(0X105E6C,	"socketConnect");
	MakeCode	(x=0X105E84);
	OpStkvar	(x,	1);
	MakeCode	(x=0X105E90);
	OpOff		(x,	1,	0);
	...
	MakeCode	(x=0X105EE4);
	OpHex		(x,	1);
	MakeComm	(0X105F00,	"session");
	MakeComm	(0X105F1C,	"sock_retval");
	MakeDword	(x=0X105F34);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X105F38);
	MakeCode	(0X105F3C);
	MakeName	(0X105F3C,	"socketIpcCmd7RecvFromOther");
	MakeCode	(x=0X105F54);
	OpStkvar	(x,	1);
	MakeCode	(x=0X105F58);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X106060);
	MakeName	(0X106060,	"socketIpcCmd8RecvFrom");
	MakeCode	(x=0X106074);
	OpStkvar	(x,	1);
	MakeCode	(x=0X106078);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X1061A8);
	MakeName	(0X1061A8,	"socketIpcCmd9SendToOther");
	MakeCode	(x=0X1061B4);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1061BC);
	OpStkvar	(x,	1);
	...
	MakeComm	(0X106294,	"sock_retval");
	MakeDword	(x=0X1062B4);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X1062B8);
	MakeCode	(0X1062BC);
	MakeName	(0X1062BC,	"socketIpcCmdASendTo");
	MakeCode	(x=0X1062C8);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1062D0);
	OpStkvar	(x,	1);
	...
	MakeCode	(x=0X1063D4);
	OpStkvar	(x,	1);
	MakeName	(0X1063D4,	"socketRecvFrom");
	MakeCode	(x=0X1063DC);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1063E0);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1063E8);
	OpStkvar	(x,	1);
	MakeComm	(0X1063F0,	"src_addr");
	MakeCode	(x=0X1063F0);
	OpStkvar	(x,	1);
	MakeComm	(0X1063F4,	"addrlen");
	MakeCode	(x=0X1063F4);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1063F8);
	OpStkvar	(x,	1);
	MakeCode	(x=0X106400);
	OpStkvar	(x,	1);
	MakeName	(0X106400,	"socketSendTo");
	MakeCode	(x=0X106408);
	OpStkvar	(x,	1);
	MakeCode	(x=0X10640C);
	OpStkvar	(x,	1);
	MakeCode	(x=0X106414);
	OpStkvar	(x,	1);
	MakeComm	(0X10641C,	"dest_addr");
	MakeCode	(x=0X10641C);
	OpStkvar	(x,	1);
	MakeComm	(0X106420,	"addrlen");
	MakeCode	(x=0X106420);
	OpStkvar	(x,	1);
	MakeCode	(x=0X106424);
	OpStkvar	(x,	1);
	MakeCode	(0X10642C);
	MakeName	(0X10642C,	"socketRecv");
	MakeComm	(0X106434,	"src_addr");
	MakeCode	(x=0X106434);
	OpStkvar	(x,	1);
	MakeComm	(0X106438,	"addrlen");
	MakeCode	(x=0X106438);
	OpStkvar	(x,	1);
	MakeCode	(x=0X106444);
	OpStkvar	(x,	1);
	MakeCode	(0X106448);
	MakeName	(0X106448,	"socketSend");
	MakeComm	(0X106450,	"dest_addr");
	MakeCode	(x=0X106450);
	OpStkvar	(x,	1);
	MakeComm	(0X106454,	"addrlen");
	MakeCode	(x=0X106454);
	OpStkvar	(x,	1);
	MakeCode	(x=0X106460);
	OpStkvar	(x,	1);
	MakeCode	(0X106464);
	MakeName	(0X106464,	"socketGetSockOpt");
	MakeCode	(x=0X106478);
	OpStkvar	(x,	1);
	MakeCode	(x=0X106494);
	OpOff		(x,	1,	0);
	...
	MakeCode	(x=0X1064A4);
	OpHex		(x,	1);
	MakeComm	(0X1064C0,	"session");
	MakeComm	(0X1064E4,	"sock_retval");
	MakeCode	(0X106500);
	MakeCode	(0X10650C);
	MakeDword	(0X106514);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X10651C);
	MakeName	(0X10651C,	"socketSetSockOpt");
	MakeCode	(x=0X10652C);
	OpStkvar	(x,	1);
	MakeCode	(x=0X106544);
	OpHex		(x,	1);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X106570,	"session");
	MakeComm	(0X10658C,	"sock_retval");
	MakeDword	(0X1065A4);
	MakeDword	(x=0X1065A8);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X1065AC);
	MakeName	(0X1065AC,	"socketFcntl");
	MakeCode	(x=0X1065B8);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1065C4);
	OpStkvar	(x,	1);
	...
	MakeCode	(x=0X106600);
	OpHex		(x,	1);
	MakeComm	(0X106628,	"session");
	MakeComm	(0X106644,	"sock_retval");
	MakeDword	(x=0X10666C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeDword	(0X106670);
	MakeCode	(0X106674);
	MakeName	(0X106674,	"socketAtMark");
	MakeCode	(x=0X106688);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X106698,	"session");
	MakeComm	(0X1066B4,	"sock_retval");
	MakeDword	(0X1066CC);
	MakeDword	(x=0X1066D0);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X1066D4);
	MakeName	(0X1066D4,	"socketGetHostId");
	MakeCode	(x=0X1066E4);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1066EC,	"session");
	MakeDword	(x=0X106710);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X106714);
	MakeName	(0X106714,	"socketGetSockName");
	MakeCode	(x=0X106730);
	OpStkvar	(x,	1);
	MakeCode	(x=0X106740);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X106764,	"session");
	MakeComm	(0X106788,	"sock_retval");
	MakeCode	(x=0X106798);
	OpOff		(x,	1,	0X10B490);
	OpOff		(x,	129,	0X10B490);
	MakeCode	(0X1067A4);
	...
	MakeDword	(0X106800);
	MakeCode	(0X106804);
	MakeName	(0X106804,	"socketGetPeerName");
	MakeCode	(x=0X106820);
	OpStkvar	(x,	1);
	MakeCode	(x=0X106830);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X106854,	"session");
	MakeComm	(0X106878,	"sock_retval");
	MakeCode	(x=0X106888);
	OpOff		(x,	1,	0X10B490);
	OpOff		(x,	129,	0X10B490);
	MakeCode	(0X106894);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X1068F4,	"srvExit");
	MakeComm	(0X106900,	"handle");
	MakeDword	(x=0X10691C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X106920);
	MakeName	(0X106920,	"srvRegisterClient");
	MakeCode	(x=0X106928);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	MakeCode	(0X106994);
	MakeName	(0X106994,	"srvGetServiceHandle");
	MakeCode	(x=0X1069A0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1069A8,	"a1");
	MakeCode	(x=0X1069C8);
	OpHex		(x,	1);
	MakeComm	(0X1069D8,	"GetServiceSessionHandle(8-byte servicename, u32 strlen, u32 flags).\nFlags bit0: if not set, return port-handle instead of session-handle\nwhen session-handle unavailable (max sessions/timeout?).");
	...
	OpOff		(x,	128,	0);
	MakeDword	(0X106A1C);
	MakeComm	(0X106A20,	"Read User read-only Thread and Process ID Register");
	MakeCode	(0X106A20);
	MakeName	(0X106A20,	"svcGetThreadCommandBuffer");
	MakeCode	(0X106A2C);
	...
	MakeCode	(x=0X106CA0);
	OpStkvar	(x,	1);
	MakeName	(0X106CA0,	"svcDebugActiveProcess");
	MakeCode	(x=0X106CA8);
	OpStkvar	(x,	1);
	MakeCode	(0X106CB4);
	MakeName	(0X106CB4,	"svcReadProcessMemory");
	MakeCode	(0X106CBC);
	MakeName	(0X106CBC,	"svcWriteProcessMemory");
	MakeArray	(0X106CC4,	0XC);
	MakeName	(0X106CC4,	"nsDbgPrint_6");
	MakeComm	(0X106CD0,	"r3 now holds handledata *?");
	MakeCode	(0X106CD0);
	MakeName	(0X106CD0,	"get_kernel_object_ptr");
	MakeComm	(0X106CD8,	"hProcess * 8");
	MakeComm	(0X106CDC,	"get Pointer to the kernel object that the handle references.");
	MakeCode	(0X106CE4);
	MakeCode	(0X106CE8);
	MakeComm	(0X106CF0,	"-> DFFFC7FC");
	MakeCode	(0X106CF0);
	MakeName	(0X106CF0,	"mmu_stuff");
	MakeComm	(0X106CF4,	"-> DFFF87FC");
	MakeCode	(x=0X106D1C);
	OpHex		(x,	1);
	MakeCode	(x=0X106D40);
	OpHex		(x,	1);
	...
	MakeDword	(0X106DD4);
	MakeCode	(0X106DD8);
	MakeName	(0X106DD8,	"install_SVC_6D_hook");
	MakeCode	(x=0X106DE0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X106DE4,	"mapped IO I2C");
	MakeComm	(0X106E00,	"get va_arm11_kernel_base");
	MakeComm	(0X106E10,	"patch error code 0xE0E01BEE");
	MakeComm	(0X106E1C,	"patch error code 0xE0E01BF5");
	MakeCode	(x=0X106E20);
	OpOff		(x,	1,	0X108618);
	OpOff		(x,	129,	0X108618);
	ExtLinA		(0X106E2C,	0,	"");
	ExtLinA		(0X106E2C,	1,	"patch svc 6D handler's code to force it to disable FIQ and IRQ");
	ExtLinA		(0X106E2C,	2,	"");
	ExtLinA		(0X106E2C,	3,	"MRS             R0, CPSR");
	ExtLinA		(0X106E2C,	4,	"ORR             R0, R0, #0xC0");
	ExtLinA		(0X106E2C,	5,	"MSR             CPSR_cf, R0");
	ExtLinA		(0X106E2C,	6,	"");
	MakeComm	(0X106E38,	"dst");
	MakeCode	(x=0X106E38);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X106E40,	"src");
	ExtLinA		(0X106E40,	0,	"");
	ExtLinA		(0X106E40,	1,	"then redirect to arm11 cmd dispatcher");
	ExtLinA		(0X106E40,	2,	"");
	MakeComm	(0X106E44,	"hook SVC 6D");
	MakeCode	(x=0X106E48);
	OpOff		(x,	1,	0X108618);
	OpOff		(x,	129,	0X108618);
	MakeCode	(x=0X106E4C);
	...
	OpOff		(x,	129,	0X108618);
	ExtLinA		(0X106E54,	0,	"");
	ExtLinA		(0X106E54,	1,	"let arm11 cb point to modified handler 6D code");
	ExtLinA		(0X106E54,	2,	"");
	MakeCode	(x=0X106E54);
	OpOff		(x,	1,	0X108618);
	OpOff		(x,	129,	0X108618);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X106ED4);
	MakeName	(0X106ED4,	"arm11kDispatchCmd");
	MakeCode	(x=0X106ED8);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeRptCmt	(0X106EE4,	"\n@arm11k_memcpy");
	ExtLinA		(0X106EE8,	0,	"handle_cmd_1:");
	MakeCode	(x=0X106EE8);
	OpOff		(x,	1,	0X10B49C);
	...
	ExtLinA		(0X106F18,	0,	"handle_cmd_2:");
	MakeCode	(x=0X106F18);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X106F1C,	"hProcess");
	MakeCode	(x=0X106F1C);
	OpOff		(x,	1,	0X10B49C);
	OpOff		(x,	129,	0X10B49C);
	MakeCode	(x=0X106F20);
	OpOff		(x,	1,	0X108618);
	OpOff		(x,	129,	0X108618);
	MakeComm	(0X106F28,	"KProcess");
	MakeComm	(0X106F2C,	"r0 points to KProcessHandleTable");
	MakeCode	(x=0X106F34);
	OpOff		(x,	1,	0X10B49C);
	OpOff		(x,	129,	0X10B49C);
	MakeRptCmt	(0X106F3C,	"\n@arm11k_set_current_kprocess");
	MakeCode	(0X106F3C);
	ExtLinA		(0X106F40,	0,	"handle_cmd_3:");
	MakeCode	(x=0X106F48);
	OpOff		(x,	1,	0X10B49C);
	OpOff		(x,	129,	0X10B49C);
	MakeRptCmt	(0X106F50,	"\n@arm11k_set_current_kprocess");
	ExtLinA		(0X106F50,	0,	"set_kprocess:");
	ExtLinA		(0X106F54,	0,	"handle_cmd_4:");
	MakeRptCmt	(0X106F68,	"\n@Unused?");
	ExtLinA		(0X106F6C,	0,	"handle_cmd_5:");
	MakeCode	(x=0X106F6C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X106F70,	"param 1");
	MakeComm	(0X106F74,	"param 2");
	MakeCode	(x=0X106F78);
	OpOff		(x,	1,	0X108618);
	OpOff		(x,	129,	0X108618);
	MakeComm	(0X106F80,	"param 3");
	MakeCode	(0X106F8C);
	MakeRptCmt	(0X106F90,	"\n@This would replace SVC 0x6D handler\nGetDebugThreadParam(s64 *, s32 *, Handle, u32, DebugThreadParam) \n@arm11k_replacel_svc_6D_handler");
	ExtLinA		(0X106F94,	0,	"handle_cmd_6:");
	MakeCode	(x=0X106F94);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X106FCC);
	MakeName	(0X106FCC,	"arm11kCmdUnused5");
	MakeCode	(x=0X106FD4);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X106FDC);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X106FFC,	"arm11kCmdSetCurrentKProcess");
	MakeCode	(x=0X107004);
	OpOff		(x,	1,	0X10B49C);
	OpOff		(x,	129,	0X10B49C);
	MakeCode	(x=0X10700C);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X107020);
	MakeName	(0X107020,	"arm11kCmdGetCurrentKProcess");
	MakeCode	(x=0X107028);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X107030);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X10704C);
	MakeName	(0X10704C,	"arm11kCmdGetKernelObject");
	MakeCode	(x=0X107054);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X10705C);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X10707C,	"arm11kCmdMemcpy");
	MakeComm	(0X107084,	"param1-3\ndst, src, count");
	MakeCode	(x=0X10708C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X107090,	"CodeAddress");
	MakeCode	(x=0X107090);
	OpOff		(x,	1,	0X108618);
	OpOff		(x,	129,	0X108618);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X1070A0,	"arm11kCmdReplaceSVC6DHandler");
	MakeCode	(x=0X1070AC);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1070B0,	"CodeAddress");
	MakeCode	(x=0X1070B0);
	OpOff		(x,	1,	0X108618);
	OpOff		(x,	129,	0X108618);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X1070C0);
	MakeName	(0X1070C0,	"nullsub_2");
	MakeCode	(0X1070C4);
	MakeName	(0X1070C4,	"pa_to_va");
	MakeCode	(0X1070D8);
	MakeCode	(0X1070EC);
	MakeCode	(0X107100);
	MakeCode	(0X107104);
	MakeName	(0X107104,	"assign_rwx_to_0x1F000000");
	...
	OpStkvar	(x,	1);
	MakeCode	(0X107188);
	MakeName	(0X107188,	"update_screen");
	MakeCode	(x=0X10718C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X107190);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X107220);
	MakeName	(0X107220,	"acquire_video");
	MakeCode	(x=0X107224);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X107228);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X107244,	"REG_LCDCOLORFILLMAIN");
	MakeComm	(0X10724C,	"REG_LCDCOLORFILLSUB");
	MakeCode	(x=0X107254);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X107268);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X107300,	"release_video");
	MakeCode	(x=0X107304);
	OpOff		(x,	1,	0X10B51C);
	OpOff		(x,	129,	0X10B51C);
	MakeCode	(x=0X107310);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X10736C);
	MakeName	(0X10736C,	"controlVideo");
	MakeCode	(0X107380);
	MakeCode	(0X107390);
	ExtLinA		(0X107398,	0,	"get_framebuffer");
	MakeCode	(x=0X107398);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(0X1073A4);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X1073D0,	"read_pad");
	MakeDword	(x=0X1073EC);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X1073F0);
	MakeName	(0X1073F0,	"wait_pad_input");
	MakeCode	(0X107420);
	...
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X107574,	"showMsg");
	MakeComm	(0X10758C,	"nanoseconds");
	MakeCode	(x=0X10759C);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1075B4,	"x");
	...
	MakeComm	(0X10764C,	"buff");
	MakeComm	(0X107650,	"fmt");
	MakeComm	(0X107660,	"msg");
	MakeCode	(x=0X107670);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeCode	(x=0X107688);
	...
	MakeCode	(x=0X1077BC);
	OpStkvar	(x,	1);
	MakeComm	(0X1077CC,	"openflags");
	MakeCode	(x=0X1077CC);
	OpStkvar	(x,	1);
	MakeComm	(0X1077D4,	"attributes");
	MakeCode	(x=0X1077D4);
	OpStkvar	(x,	1);
	MakeCode	(x=0X1077E0);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X1077E8,	"handle");
	MakeComm	(0X1077EC,	"out");
	MakeCode	(x=0X1077EC);
	OpStkvar	(x,	1);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	ExtLinA		(0X107818,	0,	"; File Name   : D:\\STATION\\rxTools.CFW\\decrypt\\NTR\\xprintf\\xprintf.o");
	ExtLinA		(0X107818,	1,	"; Format      : ELF for ARM (Relocatable)");
	ExtLinA		(0X107818,	2,	"; ");
	ExtLinA		(0X107818,	3,	"; EABI version: 5");
	ExtLinA		(0X107818,	4,	"; ");
	ExtLinA		(0X107818,	5,	"; Source File : 'xprintf.c'");
	MakeCode	(x=0X107818);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X107818,	"xputc");
	MakeCode	(x=0X107838);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	ExtLinA		(0X107840,	0,	"; File Name   : D:\\STATION\\rxTools.CFW\\decrypt\\NTR\\xprintf\\xprintf.o");
	ExtLinA		(0X107840,	1,	"; Format      : ELF for ARM (Relocatable)");
	ExtLinA		(0X107840,	2,	"; ");
	ExtLinA		(0X107840,	3,	"; EABI version: 5");
	ExtLinA		(0X107840,	4,	"; ");
	ExtLinA		(0X107840,	5,	"; Source File : 'xprintf.c'");
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X107854);
	MakeName	(0X107854,	"xputs");
	MakeComm	(0X10785C,	"c");
	MakeCode	(0X107870);
	MakeCode	(x=0X107874);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeName	(0X107874,	"xfputs");
	MakeComm	(0X10788C,	"c");
	MakeCode	(0X1078A0);
	...
	MakeCode	(0X107B60);
	MakeCode	(0X107B68);
	MakeName	(0X107B68,	"xprintf");
	MakeComm	(0X107B70,	"arp");
	MakeCode	(x=0X107B70);
	OpStkvar	(x,	1);
	MakeComm	(0X107B74,	"fmt");
	MakeCode	(x=0X107B74);
	OpStkvar	(x,	1);
	MakeCode	(x=0X107B78);
	OpStkvar	(x,	1);
	...
	OpStkvar	(x,	1);
	MakeCode	(0X107B90);
	MakeName	(0X107B90,	"xsprintf");
	MakeComm	(0X107B98,	"arp");
	MakeCode	(x=0X107B98);
	OpStkvar	(x,	1);
	MakeCode	(x=0X107B9C);
	OpOff		(x,	1,	0);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X107BD4);
	MakeName	(0X107BD4,	"xfprintf");
	MakeComm	(0X107BDC,	"arp");
	MakeCode	(x=0X107BDC);
	OpStkvar	(x,	1);
	MakeCode	(x=0X107BE0);
	OpOff		(x,	1,	0);
	...
	OpOff		(x,	128,	0);
	MakeCode	(0X107D90);
	MakeName	(0X107D90,	"xfgets");
	MakeCode	(x=0X107D94);
	OpOff		(x,	1,	0);
	OpOff		(x,	129,	0);
	MakeComm	(0X107DA0,	"buff");
	MakeComm	(0X107DA4,	"len");
	MakeDword	(x=0X107DB4);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeCode	(0X107DB8);
	MakeName	(0X107DB8,	"xatoi");
	MakeCode	(0X107E30);
	MakeCode	(0X107E44);
	MakeCode	(0X107E64);
	MakeCode	(0X107ECC);
	...
	OpHex		(x,	1);
	MakeCode	(0X1084BC);
	MakeName	(0X1084BC,	"__aeabi_uidiv");
	MakeCode	(x=0X1084D8);
	OpHex		(x,	1);
	MakeCode	(0X10855C);
	MakeCode	(0X108568);
	...
	MakeCode	(0X1085D0);
	MakeDword	(0X1085D4);
	MakeName	(0X1085D4,	"pid_of_home_menu");
	MakeDword	(0X1085D8);
	MakeName	(0X1085D8,	"va_mapped_io_LCD");
	MakeDword	(0X1085DC);
	MakeName	(0X1085DC,	"ntrKeyOpenMenu");
	MakeDword	(0X1085E0);
	MakeDword	(0X1085E4);
	MakeName	(0X1085E4,	"va_mapped_io_PDC");
	MakeDword	(0X1085E8);
	MakeName	(0X1085E8,	"va_mapped_io_PAD");
	MakeDword	(0X1085EC);
	MakeArray	(0X1085EC,	0X2);
	MakeDword	(0X1085F4);
	MakeName	(0X1085F4,	"p_plgloader_info_ver_specific");
	MakeDword	(0X1085F8);
	MakeDword	(0X1085FC);
	MakeName	(0X1085FC,	"hCurKProcess");
	MakeDword	(0X108600);
	MakeName	(0X108600,	"cfw_02");
	MakeByte	(0X108604);
	MakeByte	(0X108605);
	...
	MakeDword	(0X108618);
	MakeName	(0X108618,	"va_arm11_kernel_base_W");
	MakeDword	(0X10861C);
	MakeDword	(0X108620);
	MakeName	(0X108620,	"pcb_arm11_dispatch");
	MakeDword	(0X108624);
	MakeDword	(0X108628);
	MakeName	(0X108628,	"offs_KProcessHandleTable");
	MakeDword	(0X10862C);
	MakeDword	(0X108630);
	MakeName	(0X108630,	"offs_KCodeSet");
	MakeDword	(0X108634);
	MakeArray	(0X108634,	0X24);
	MakeName	(0X108634,	"pa_N3DS");
	MakeDword	(x=0X1086C4);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeName	(0X1086C4,	"offsets");
	MakeDword	(0X1086C8);
	...
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeName	(0X109E14,	"socketNetErrorCodeMap");
	MakeByte	(0X109E60);
	...
	MakeName	(0X10A18E,	"aFsfile_getsi_0");
	...
	MakeName	(0X10A973,	"aOpenprocessFailedRet08x");
	...
	MakeStr		(0X10AB4D,	0X10AB52);
	MakeName	(0X10AB4D,	"aDump");
	...
	MakeStr		(0X10AC7C,	0X10AC90);
	MakeName	(0X10AC7C,	"aPressBToClose_");
	MakeStr		(0X10AC90,	0X10AC95);
	MakeName	(0X10AC90,	"aDbg");
	MakeStr		(0X10AC95,	0X10AC9C);
	MakeName	(0X10AC95,	"a08lx");
	MakeStr		(0X10AC9C,	0X10ACA2);
	MakeName	(0X10AC9C,	"a02x");
	MakeStr		(0X10ACA2,	0X10ACA8);
	MakeName	(0X10ACA2,	"a04x");
	MakeStr		(0X10ACA8,	0X10ACAF);
	MakeName	(0X10ACA8,	"a08lx_0");
	MakeByte	(0X10ACAF);
	MakeDword	(0X10ACB0);
	MakeArray	(0X10ACB0,	0XA);
	MakeDword	(0X10ACD8);
	MakeDword	(0X10ACDC);
	MakeDword	(0X10ACE0);
	MakeDword	(0X10ACF4);
	MakeName	(0X10ACF4,	"firmware_version_internal");
	MakeDword	(0X10ACF8);
	MakeDword	(0X10ACFC);
	MakeName	(0X10ACFC,	"hFSUser");
	MakeName	(0X10AD00,	"ntrKeyScreenShot");
	MakeDword	(0X10AD04);
	MakeDword	(x=0X10AD08);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeName	(0X10AD08,	"allowDirectScreenAccess");
	MakeDword	(0X10AD0C);
	MakeDword	(0X10AD18);
	MakeName	(0X10AD18,	"process_manager_patch_addr");
	MakeName	(0X10AD1C,	"rthook_return_C821180B");
	MakeDword	(0X10AD60);
	MakeDword	(0X10ADE8);
	MakeName	(0X10ADE8,	"nintendo_home_ptr_fsuser_handle");
	MakeName	(0X10ADEC,	"rthook_patch_smdh");
	MakeDword	(0X10AE78);
	MakeArray	(0X10AE78,	0X10);
	MakeDword	(0X10AEB8);
	MakeName	(0X10AEB8,	"nintendo_home_nss_CardUpdateInitialize_addr");
	MakeDword	(0X10AEBC);
	MakeName	(0X10AEBC,	"nintendo_home_applet_start_hook_addr");
	MakeDword	(0X10AEC0);
	MakeName	(0X10AEC0,	"rthook");
	MakeDword	(0X10AEC4);
	MakeName	(0X10AEC4,	"nintendo_home_FlushDataCache_addr");
	MakeDword	(0X10AEC8);
	MakeName	(0X10AEC8,	"ntrNetworkDebugServerStack");
	MakeDword	(0X10AECC);
	MakeArray	(0X10AECC,	0X2);
	MakeDword	(0X10AED4);
	MakeName	(0X10AED4,	"p_config_memory");
	MakeDword	(0X10AED8);
	MakeDword	(0X10AEDC);
	MakeRptCmt	(0X10AEE0,	"means failed when 0x7000000");
	MakeDword	(0X10AEE0);
	MakeName	(0X10AEE0,	"plgMemoryAlloced");
	MakeDword	(0X10AEE4);
	MakeDword	(0X10AEE8);
	MakeName	(0X10AEE8,	"arm11BinStart");
	MakeDword	(0X10AEEC);
	MakeName	(0X10AEEC,	"arm11BinSize");
	MakeDword	(0X10AEF0);
	MakeDword	(0X10AEF4);
	MakeDword	(0X10AEF8);
	MakeArray	(0X10AEF8,	0X23);
	MakeDword	(0X10AF84);
	MakeArray	(0X10AF84,	0X10);
	MakeDword	(0X10AFC4);
	MakeArray	(0X10AFC4,	0XF5);
	MakeName	(0X10AFC4,	"g_plugin_func_ptrs?");
	MakeByte	(0X10B398);
	MakeName	(0X10B398,	"some_filename?");
	MakeByte	(0X10B399);
	...
	MakeDword	(0X10B3AC);
	MakeName	(0X10B3AC,	"p_plgloader_info");
	MakeDword	(0X10B3B0);
	MakeName	(0X10B3B0,	"arm11BinEnd2");
	MakeDword	(0X10B3B4);
	MakeArray	(0X10B3B4,	0X23);
	MakeName	(0X10B3B4,	"rthook_applet_start");
	MakeDword	(0X10B440);
	MakeArray	(0X10B440,	0X10);
	MakeDword	(0X10B480);
	MakeName	(0X10B480,	"cur_pid");
	MakeDword	(0X10B484);
	MakeName	(0X10B484,	"hProcess_0");
	MakeDword	(0X10B488);
	MakeDword	(0X10B48C);
	MakeName	(0X10B48C,	"bmp_idx");
	MakeDword	(0X10B490);
	MakeName	(0X10B490,	"socketHandle");
	MakeDword	(0X10B494);
	MakeDword	(0X10B498);
	MakeName	(0X10B498,	"srcHandle");
	MakeDword	(0X10B49C);
	MakeName	(0X10B49C,	"g_arm11_cmd");
	MakeDword	(0X10B4A0);
	MakeName	(0X10B4A0,	"g_arm11_handle");
	MakeDword	(0X10B4A4);
	MakeDword	(0X10B4A8);
	MakeDword	(0X10B4AC);
	MakeArray	(0X10B4AC,	0X1C);
	MakeDword	(0X10B51C);
	MakeName	(0X10B51C,	"is_NTR_OSD_requested");
	MakeDword	(0X10B520);
	MakeDword	(0X10B524);
	...
	MakeDword	(0X10B554);
	MakeName	(0X10B554,	"outptr");
	MakeDword	(x=0X10B558);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeName	(0X10B558,	"xfunc_in");
	MakeDword	(x=0X10B55C);
	OpOff		(x,	0,	0);
	OpOff		(x,	128,	0);
	MakeName	(0X10B55C,	"xfunc_out");
}

static Functions_0(void) {

	MakeFunction    (0X100100,0X100104);
	SetFunctionFlags(0X100100,0x400);
	MakeFunction    (0X100124,0X1001A4);
	SetFunctionFlags(0X100124,0x400);
	MakeFrame(0X100124, 0X38, 0, 0);
	MakeFunction    (0X1001D0,0X1001FC);
	SetFunctionFlags(0X1001D0,0x404);
	SetType(0X1001D0, "void __usercall ntr2dPaintPixel(int x@<R0>, int y@<R1>, unsigned __int8 r@<R2>, unsigned __int8 g@<R3>, unsigned __int8 b, int screen);");
	...
	SetType(0X1001FC, "void __stdcall ntr2dPaintSquare(int x, int y, int xs, int ys);");
	...
	SetType(0X100270, "void __stdcall ntr2dBlank(int x, int y, int xs, int ys);");
	...
	SetType(0X1002DC, "void __usercall ntr2dPaintLetter(unsigned __int8 letter@<R0>, int x@<R1>, int y@<R2>, unsigned __int8 r@<R3>, unsigned __int8 g, unsigned __int8 b, int screen);");
	...
	SetType(0X100378, "void __stdcall ntr2dPaintWord(char *word, int x, int y, char r, char g, char b, int screen);");
	...
	SetType(0X1003F8, "void __stdcall ntr2dPrint(char *s, int x, int y, char r, char g, char b);");
	...
	SetType(0X10065C, "void __fastcall ntrInstall(uint32_t *reg);");
	MakeFunction    (0X100688,0X10068C);
	SetFunctionFlags(0X100688,0x400);
	SetType(0X100688, "void IRQHandler(void);");
	...
	SetType(0X100930, "Result __stdcall FSUSER_CloseArchive(Handle handle, FS_archive *archive);");
	...
	SetType(0X1009B4, "Result __stdcall FSFILE_Read(Handle handle, u32 *bytesRead, u64 offset, u32 *buffer, u32 size);");
	...
	SetType(0X100A20, "Result __stdcall FSFILE_Write(Handle handle, u32 *bytesWritten, u64 offset, u32 *data, u32 size, u32 flushFlags);");
	MakeFrame(0X100A20, 0X20, 0, 0);
	MakeLocal(0X100A20, 0X100A90, "[bp+0]", "size");
	MakeLocal(0X100A20, 0X100A90, "[bp+0X4]", "flushFlags");
	...
	SetType(0X100B14, "Result __stdcall FSDIR_Read(Handle handle, u32 *entriesRead, u32 entrycount, u16 *buffer);");
	MakeFrame(0X100B14, 0X18, 0, 0);
	MakeFunction    (0X100B78,0X100BA4);
	SetFunctionFlags(0X100B78,0x400);
	SetType(0X100B78, "Result __stdcall FSDIR_Close(Handle handle);");
	...
	MakeFunction    (0X10111C,0X1011B4);
	SetFunctionFlags(0X10111C,0x400);
	MakeFrame(0X10111C, 0X100, 0, 0);
	MakeLocal(0X10111C, 0X1011B4, "[bp-0XD8]", "buff");
	...
	MakeFunction    (0X1013F4,0X101458);
	SetFunctionFlags(0X1013F4,0x400);
	MakeFrame(0X1013F4, 0X18, 0, 0);
	MakeLocal(0X1013F4, 0X101458, "[bp-0X18]", "handle");
	MakeFunction    (0X101458,0X1014D4);
	SetFunctionFlags(0X101458,0x400);
	MakeFrame(0X101458, 0X20, 0, 0);
	MakeLocal(0X101458, 0X1014D4, "[bp-0X20]", "operation");
	MakeLocal(0X101458, 0X1014D4, "[bp-0X1C]", "permissions");
	...
	MakeLocal(0X1014DC, 0X10155C, "[bp-0X240]", "buf");
	...
	SetType(0X1018EC, "unsigned __int8 __fastcall ntrMemoryNibbleToReadable(u8 nibble);");
	MakeFunction    (0X101900,0X10193C);
	SetFunctionFlags(0X101900,0x400);
	SetType(0X101900, "u32 __fastcall ntrMemoryByteToString(u8 byte, unsigned __int8 *ret, int max_len);");
	MakeFunction    (0X10193C,0X101994);
	SetFunctionFlags(0X10193C,0x404);
	SetType(0X10193C, "u32 __fastcall ntrMemoryU32ToString(u32 byte, unsigned __int8 *ret, int max_len);");
	...
	SetType(0X101A14, "int __stdcall sendMsg(u8 *msg);");
	MakeFrame(0X101A14, 0X20, 0, 0);
	MakeLocal(0X101A14, 0X101A70, "[bp-0X1C]", "arp");
	...
	MakeLocal(0X101B44, 0X101C6C, "[bp-0X230]", "bytesWritten");
	...
	MakeLocal(0X10204C, 0X102110, "[bp-0X654]", "src");
	...
	MakeLocal(0X1021FC, 0X10235C, "[bp-0X2C]", "bytesRead");
	...
	MakeLocal(0X102508, 0X102660, "[bp-0X30]", "size");
	...
	MakeLocal(0X10267C, 0X1027D8, "[bp-0X30]", "size");
	...
	MakeLocal(0X10298C, 0X102AA8, "[bp-0X7F0]", "hProcess");
	MakeFunction    (0X102AC4,0X102C68);
	SetFunctionFlags(0X102AC4,0x400);
	SetType(0X102AC4, "Result __cdecl inject_ntr_into_remote_process(Handle handle, u32 addr_jmpcode, void *buf);");
	MakeFrame(0X102AC4, 0X78, 0, 0);
	MakeLocal(0X102AC4, 0X102C68, "[bp-0X78]", "size");
	MakeLocal(0X102AC4, 0X102C68, "[bp-0X70]", "src_addr");
	...
	MakeLocal(0X102CA8, 0X102D48, "[bp-0X248]", "buf");
	...
	SetType(0X10336C, "u32 __fastcall osConvertVaddr2Physaddr(u32 vaddr);");
	...
	MakeLocal(0X1033A8, 0X1033C8, "[bp-0XC]", "process");
	MakeFunction    (0X1033C8,0X1033D0);
	SetFunctionFlags(0X1033C8,0x404);
	SetType(0X1033C8, "u32 __stdcall plgRegisterCallback(u32 type, void *callback, u32 param0);");
	MakeFunction    (0X1033D0,0X103448);
	SetFunctionFlags(0X1033D0,0x400);
	SetType(0X1033D0, "u32 __stdcall plgRequestMemory(u32 size);");
	...
	SetType(0X103454, "u32 __stdcall plgGetSharedServiceHandle(char *servName, Handle *handle);");
	MakeFrame(0X103454, 0X8, 0, 0);
	MakeFunction    (0X103488,0X1034C4);
	SetFunctionFlags(0X103488,0x400);
	SetType(0X103488, "void *__stdcall plgGetIoBase(int IoIndex);");
	MakeFunction    (0X1034D0,0X103548);
	SetFunctionFlags(0X1034D0,0x400);
	SetType(0X1034D0, "int __cdecl ntrResetKProcessRefcount(u32 processid);");
	...
	SetType(0X103554, "void ntrSetHotkey(void);");
	MakeFrame(0X103554, 0X28, 0, 0);
	MakeFunction    (0X1035F8,0X103738);
	SetFunctionFlags(0X1035F8,0x400);
	SetType(0X1035F8, "void ntrMenu(void);");
	MakeFrame(0X1035F8, 0X238, 0, 0);
	MakeFunction    (0X10375C,0X10379C);
	SetFunctionFlags(0X10375C,0x400);
	SetType(0X10375C, "u32 __stdcall plgRegisterMenuEntry(u32 catalog, char *title, void *callback);");
	MakeFrame(0X10375C, 0XC, 0, 0);
	MakeFunction    (0X1037A4,0X103848);
	SetFunctionFlags(0X1037A4,0x400);
	SetType(0X1037A4, "Result __fastcall ntrAllocPluginMemory(u32 size, int a2, int a3, u32 *targetAddress);");
	MakeFrame(0X1037A4, 0X28, 0, 0);
	MakeLocal(0X1037A4, 0X103848, "[bp-0X1C]", "addr_out");
	MakeFunction    (0X103860,0X1038C0);
	SetFunctionFlags(0X103860,0x400);
	SetType(0X103860, "void ntrGetFSUserHandle(void);");
	MakeFrame(0X103860, 0X8, 0, 0);
	MakeFunction    (0X1038D4,0X103B30);
	SetFunctionFlags(0X1038D4,0x400);
	MakeFrame(0X1038D4, 0X498, 0, 0);
	MakeLocal(0X1038D4, 0X103B30, "[bp-0X498]", "size");
	MakeLocal(0X1038D4, 0X103B30, "[bp-0X488]", "dst_addr");
	MakeLocal(0X1038D4, 0X103B30, "[bp-0X260]", "buf");
	...
	MakeLocal(0X103D80, 0X103E78, "[bp-0X11A8]", "buff");
	...
	MakeLocal(0X103F28, 0X103FA4, "[bp-0X240]", "buf");
	...
	SetType(0X104248, "uint32_t __stdcall ntrGetCurrentProcessId();");
	MakeFrame(0X104248, 0X8, 0, 0);
	MakeFunction    (0X10426C,0X1042C8);
	SetFunctionFlags(0X10426C,0x400);
	SetType(0X10426C, "Handle ntrGetCurrentProcessHandle(void);");
	...
	SetType(0X1042D8, "uint32_t __fastcall controlRemoteMemory(void *addr, size_t size);");
	MakeFrame(0X1042D8, 0X30, 0, 0);
	MakeLocal(0X1042D8, 0X104370, "[bp-0X24]", "v1");
	MakeFunction    (0X10437C,0X1043A0);
	SetFunctionFlags(0X10437C,0x400);
	SetType(0X10437C, "uint32_t __fastcall ntrProtectRemoteMemory(Handle hProcess, void *addr, uint32_t size);");
	MakeFrame(0X10437C, 0X10, 0, 0);
	MakeFunction    (0X1043A0,0X1043C0);
	SetFunctionFlags(0X1043A0,0x400);
	SetType(0X1043A0, "uint32_t __fastcall ntrProtectMemory(void *addr, uint32_t size);");
	MakeFrame(0X1043A0, 0X10, 0, 0);
	MakeFunction    (0X1043C0,0X104504);
	SetFunctionFlags(0X1043C0,0x400);
	SetType(0X1043C0, "Result __fastcall inter_process_dma_copy(Handle hDst, void *dst_addr, Handle hSrc, const void *src_addr, u32 size);");
	...
	MakeLocal(0X1043C0, 0X104504, "[bp+0]", "size");
	MakeFunction    (0X104524,0X104574);
	SetFunctionFlags(0X104524,0x400);
	SetType(0X104524, "Result __fastcall sub_104524(Handle handle, u32 *a2);");
	MakeFrame(0X104524, 0X208, 0, 0);
	MakeLocal(0X104524, 0X104574, "[bp-0X108]", "dst");
	MakeFunction    (0X104578,0X104630);
	SetFunctionFlags(0X104578,0x400);
	SetType(0X104578, "Result __fastcall get_process_name(u32 processId, int a2, int a3, int a4);");
	MakeFrame(0X104578, 0X228, 0, 0);
	MakeLocal(0X104578, 0X104630, "[bp-0X224]", "process");
	MakeLocal(0X104578, 0X104630, "[bp-0X220]", "dst");
	MakeFunction    (0X104638,0X1047CC);
	SetFunctionFlags(0X104638,0x400);
	SetType(0X104638, "void __cdecl dumpProcessToFile(u32 processId, char *filename);");
	MakeFrame(0X104638, 0X1078, 0, 0);
	MakeLocal(0X104638, 0X1047CC, "[bp-0X1078]", "size");
	...
	MakeLocal(0X104638, 0X1047CC, "[bp-0X1038]", "buff");
	MakeFunction    (0X1047F0,0X104988);
	SetFunctionFlags(0X1047F0,0x400);
	MakeFrame(0X1047F0, 0X1078, 0, 0);
	MakeLocal(0X1047F0, 0X104988, "[bp-0X1078]", "g");
	MakeLocal(0X1047F0, 0X104988, "[bp-0X1074]", "b");
	MakeLocal(0X1047F0, 0X104988, "[bp-0X105C]", "openflags");
	MakeLocal(0X1047F0, 0X104988, "[bp-0X1058]", "attributes");
	MakeLocal(0X1047F0, 0X104988, "[bp-0X1050]", "handle_out");
	MakeLocal(0X1047F0, 0X104988, "[bp-0X104C]", "out");
	MakeLocal(0X1047F0, 0X104988, "[bp-0X1038]", "buff");
	MakeFunction    (0X1049A8,0X104AEC);
	SetFunctionFlags(0X1049A8,0x400);
	SetType(0X1049A8, "s32 __stdcall dumpMemoryToFile(u32 va_dumpaddr, u32 size, char *filename);");
	MakeFrame(0X1049A8, 0X1128, 0, 0);
	MakeLocal(0X1049A8, 0X104AEC, "[bp-0X1128]", "size");
	...
	MakeLocal(0X1049A8, 0X104AEC, "[bp-0X10FC]", "bytesWritten");
	MakeLocal(0X1049A8, 0X104AEC, "[bp-0X10E8]", "buff");
	MakeFunction    (0X104B0C,0X104B90);
	SetFunctionFlags(0X104B0C,0x400);
	MakeFrame(0X104B0C, 0X28, 0, 0);
	MakeLocal(0X104B0C, 0X104B90, "[bp-0X28]", "size");
	...
	MakeLocal(0X105020, 0X105150, "[bp-0X3C]", "bytesRead");
	...
	SetType(0X105318, "Handle __stdcall ntrFileCreate(char *filename, u32 mode);");
	...
	MakeLocal(0X105398, 0X1053CC, "[bp-0X14]", "bytesRead");
	MakeFunction    (0X1053CC,0X105408);
	SetFunctionFlags(0X1053CC,0x400);
	SetType(0X1053CC, "u32 __fastcall ntrFileWrite(Handle file, u64 offset, char *buffer, u32 size);");
	MakeFrame(0X1053CC, 0X28, 0, 0);
	MakeLocal(0X1053CC, 0X105408, "[bp-0X14]", "bytesWritten");
	MakeFunction    (0X105408,0X10540C);
	SetFunctionFlags(0X105408,0x480);
	SetType(0X105408, "Result __stdcall ntrFileClose(Handle handle);");
	MakeFunction    (0X10540C,0X10542C);
	SetFunctionFlags(0X10540C,0x400);
	SetType(0X10540C, "u8 *__fastcall ntrU32ToU8Array(u8 *array, u32 number);");
	MakeFunction    (0X10542C,0X10543C);
	SetFunctionFlags(0X10542C,0x400);
	SetType(0X10542C, "u16 __stdcall ntrU16ToU8Array(u8 *array, u16 number);");
	MakeFunction    (0X10543C,0X105544);
	SetFunctionFlags(0X10543C,0x400);
	SetType(0X10543C, "u32 __fastcall ntrScreenShotSaveFile(char *buffer, u16 width, u16 height, char *filename);");
	...
	SetType(0X105674, "u32 ntrScreenShotGetIndex(void);");
	MakeFrame(0X105674, 0X48, 0, 0);
	MakeFunction    (0X1056C0,0X105840);
	SetFunctionFlags(0X1056C0,0x400);
	MakeFrame(0X1056C0, 0X78, 0, 0);
	MakeLocal(0X1056C0, 0X105840, "[bp-0X60]", "buff");
	MakeFunction    (0X105864,0X1058C4);
	SetFunctionFlags(0X105864,0x400);
	MakeFrame(0X105864, 0X10, 0, 0);
	MakeFunction    (0X1058C8,0X10591C);
	SetFunctionFlags(0X1058C8,0x400);
	SetType(0X1058C8, "void ntrScreenShotBuiltinPluginInit(void);");
	MakeFrame(0X1058C8, 0X8, 0, 0);
	MakeFunction    (0X10593C,0X105990);
	SetFunctionFlags(0X10593C,0x400);
	SetType(0X10593C, "void ntrPlgInitSharedFunctions(void);");
	MakeFunction    (0X1059B8,0X1059F0);
	SetFunctionFlags(0X1059B8,0x400);
	SetType(0X1059B8, "s32 __stdcall socketNetConvertError(s32 sock_retval);");
	MakeFunction    (0X1059F4,0X105A3C);
	SetFunctionFlags(0X1059F4,0x400);
	SetType(0X1059F4, "Result __stdcall socketCmd1(Handle memhandle, u32 memsize);");
	MakeFrame(0X1059F4, 0X10, 0, 0);
	MakeFunction    (0X105A80,0X105AE0);
	SetFunctionFlags(0X105A80,0x400);
	SetType(0X105A80, "Result __stdcall socketInitialize(u32 *context_addr, u32 context_size);");
	MakeFrame(0X105A80, 0X18, 0, 0);
	MakeLocal(0X105A80, 0X105AE0, "[bp-0X18]", "otherpermission");
	MakeLocal(0X105A80, 0X105AE0, "[bp-0XC]", "memhandle");
	MakeFunction    (0X105AE8,0X105AF4);
	SetFunctionFlags(0X105AE8,0x400);
	SetType(0X105AE8, "int socketGetErrno(void);");
	MakeFunction    (0X105AF8,0X105B60);
	SetFunctionFlags(0X105AF8,0x400);
	SetType(0X105AF8, "int __stdcall socketOpen(int domain, int type, int protocol);");
	MakeFrame(0X105AF8, 0X18, 0, 0);
	MakeFunction    (0X105B68,0X105BC0);
	SetFunctionFlags(0X105B68,0x400);
	SetType(0X105B68, "int __stdcall socketClose(int sockfd);");
	MakeFrame(0X105B68, 0X10, 0, 0);
	MakeFunction    (0X105BC8,0X105C28);
	SetFunctionFlags(0X105BC8,0x400);
	SetType(0X105BC8, "int __stdcall socketShutdown(int sockfd, int shutdown_type);");
	MakeFrame(0X105BC8, 0X10, 0, 0);
	MakeFunction    (0X105C30,0X105C90);
	SetFunctionFlags(0X105C30,0x400);
	SetType(0X105C30, "int __stdcall socketListen(int sockfd, int max_connections);");
	MakeFrame(0X105C30, 0X10, 0, 0);
	MakeFunction    (0X105C98,0X105D90);
	SetFunctionFlags(0X105C98,0x400);
	SetType(0X105C98, "int __stdcall socketAccept(int sockfd, struct sockaddr *addr, int *addrlen);");
	MakeFrame(0X105C98, 0X48, 0, 0);
	MakeFunction    (0X105D9C,0X105E64);
	SetFunctionFlags(0X105D9C,0x400);
	SetType(0X105D9C, "int __stdcall socketBind(int sockfd, const struct sockaddr *addr, int addrlen);");
	MakeFrame(0X105D9C, 0X40, 0, 0);
	MakeFunction    (0X105E6C,0X105F34);
	SetFunctionFlags(0X105E6C,0x400);
	SetType(0X105E6C, "int __stdcall socketConnect(int sockfd, const struct sockaddr *addr, int addrlen);");
	MakeFrame(0X105E6C, 0X40, 0, 0);
	MakeFunction    (0X105F3C,0X106058);
	SetFunctionFlags(0X105F3C,0x400);
	SetType(0X105F3C, "int __stdcall socketIpcCmd7RecvFromOther(int sockfd, void *buf, int len, int flags, struct sockaddr *src_addr, int *addrlen);");
	MakeFrame(0X105F3C, 0X48, 0, 0);
	MakeLocal(0X105F3C, 0X106058, "[bp+0]", "src_addr");
	MakeLocal(0X105F3C, 0X106058, "[bp+0X4]", "addrlen");
	MakeFunction    (0X106060,0X1061A0);
	SetFunctionFlags(0X106060,0x400);
	SetType(0X106060, "int __stdcall socketIpcCmd8RecvFrom(int sockfd, void *buf, int len, int flags, struct sockaddr *src_addr, int *addrlen);");
	MakeFrame(0X106060, 0X58, 0, 0);
	MakeLocal(0X106060, 0X1061A0, "[bp+0]", "src_addr");
	MakeLocal(0X106060, 0X1061A0, "[bp+0X4]", "addrlen");
	MakeFunction    (0X1061A8,0X1062B4);
	SetFunctionFlags(0X1061A8,0x400);
	SetType(0X1061A8, "int __stdcall socketIpcCmd9SendToOther(int sockfd, const void *buf, int len, int flags, const struct sockaddr *dest_addr, int addrlen);");
	MakeFrame(0X1061A8, 0X50, 0, 0);
	MakeLocal(0X1061A8, 0X1062B4, "[bp+0]", "dest_addr");
	MakeLocal(0X1061A8, 0X1062B4, "[bp+0X4]", "addrlen");
	MakeFunction    (0X1062BC,0X1063CC);
	SetFunctionFlags(0X1062BC,0x400);
	SetType(0X1062BC, "int __stdcall socketIpcCmdASendTo(int sockfd, const void *buf, int len, int flags, const struct sockaddr *dest_addr, int addrlen);");
	MakeFrame(0X1062BC, 0X50, 0, 0);
	MakeLocal(0X1062BC, 0X1063CC, "[bp+0]", "dest_addr");
	MakeLocal(0X1062BC, 0X1063CC, "[bp+0X4]", "addrlen");
	MakeFunction    (0X1063D4,0X106400);
	SetFunctionFlags(0X1063D4,0x400);
	SetType(0X1063D4, "int __stdcall socketRecvFrom(int sockfd, void *buf, int len, int flags, struct sockaddr *src_addr, int *addrlen);");
	MakeFrame(0X1063D4, 0X4, 0, 0);
	MakeLocal(0X1063D4, 0X106400, "[bp+0]", "src_addr");
	MakeLocal(0X1063D4, 0X106400, "[bp+0X4]", "addrlen");
	MakeFunction    (0X106400,0X10642C);
	SetFunctionFlags(0X106400,0x400);
	SetType(0X106400, "int __stdcall socketSendTo(int sockfd, const void *buf, int len, int flags, const struct sockaddr *dest_addr, int addrlen);");
	MakeFrame(0X106400, 0X4, 0, 0);
	MakeLocal(0X106400, 0X10642C, "[bp+0]", "dest_addr");
	MakeLocal(0X106400, 0X10642C, "[bp+0X4]", "addrlen");
	MakeFunction    (0X10642C,0X106448);
	SetFunctionFlags(0X10642C,0x400);
	SetType(0X10642C, "int __stdcall socketRecv(int sockfd, void *buf, int len, int flags);");
	MakeFrame(0X10642C, 0X10, 0, 0);
	MakeLocal(0X10642C, 0X106448, "[bp-0X10]", "src_addr");
	MakeLocal(0X10642C, 0X106448, "[bp-0XC]", "addrlen");
	MakeFunction    (0X106448,0X106464);
	SetFunctionFlags(0X106448,0x400);
	SetType(0X106448, "int __stdcall socketSend(int sockfd, const void *buf, int len, int flags);");
	MakeFrame(0X106448, 0X10, 0, 0);
	MakeLocal(0X106448, 0X106464, "[bp-0X10]", "dest_addr");
	MakeLocal(0X106448, 0X106464, "[bp-0XC]", "addrlen");
	MakeFunction    (0X106464,0X106514);
	SetFunctionFlags(0X106464,0x400);
	SetType(0X106464, "int __stdcall socketGetSockOpt(int sockfd, int level, int option_name, void *data, int *data_len);");
	MakeFrame(0X106464, 0X20, 0, 0);
	MakeLocal(0X106464, 0X106514, "[bp+0]", "data_len");
	MakeFunction    (0X10651C,0X1065A4);
	SetFunctionFlags(0X10651C,0x400);
	SetType(0X10651C, "int __stdcall socketSetSockOpt(int sockfd, int level, int option_name, const void *data, int data_len);");
	MakeFrame(0X10651C, 0X20, 0, 0);
	MakeLocal(0X10651C, 0X1065A4, "[bp+0]", "data_len");
	MakeFunction    (0X1065AC,0X10666C);
	SetFunctionFlags(0X1065AC,0x400);
	SetType(0X1065AC, "int socketFcntl(int sockfd, int cmd, ...);");
	MakeFrame(0X1065AC, 0X28, 0, 0);
	MakeLocal(0X1065AC, 0X10666C, "[bp-0XC]", "varg_r1");
	MakeLocal(0X1065AC, 0X10666C, "[bp-0X8]", "varg_r2");
	MakeLocal(0X1065AC, 0X10666C, "[bp-0X4]", "varg_r3");
	MakeFunction    (0X106674,0X1066CC);
	SetFunctionFlags(0X106674,0x400);
	SetType(0X106674, "int __stdcall socketAtMark(int sockfd);");
	MakeFrame(0X106674, 0X10, 0, 0);
	MakeFunction    (0X1066D4,0X106710);
	SetFunctionFlags(0X1066D4,0x400);
	SetType(0X1066D4, "__int32 __stdcall socketGetHostId();");
	MakeFrame(0X1066D4, 0X8, 0, 0);
	MakeFunction    (0X106714,0X1067F8);
	SetFunctionFlags(0X106714,0x400);
	SetType(0X106714, "int __stdcall socketGetSockName(int sockfd, struct sockaddr *addr, int *addr_len);");
	MakeFrame(0X106714, 0X40, 0, 0);
	MakeFunction    (0X106804,0X1068E8);
	SetFunctionFlags(0X106804,0x400);
	SetType(0X106804, "int __stdcall socketGetPeerName(int sockfd, struct sockaddr *addr, int *addr_len);");
	MakeFrame(0X106804, 0X40, 0, 0);
	MakeFunction    (0X1068F4,0X10691C);
	SetFunctionFlags(0X1068F4,0x400);
	SetType(0X1068F4, "Result __stdcall srvExit();");
	MakeFrame(0X1068F4, 0X8, 0, 0);
	MakeFunction    (0X106920,0X106958);
	SetFunctionFlags(0X106920,0x400);
	SetType(0X106920, "Result __fastcall srvRegisterClient(Handle *handleptr);");
	MakeFrame(0X106920, 0X10, 0, 0);
	MakeFunction    (0X106960,0X10698C);
	SetFunctionFlags(0X106960,0x400);
	SetType(0X106960, "Result __stdcall srvInit();");
	MakeFrame(0X106960, 0X8, 0, 0);
	MakeFunction    (0X106994,0X106A18);
	SetFunctionFlags(0X106994,0x400);
	SetType(0X106994, "Result __fastcall srvGetServiceHandle(Handle *handleptr, Handle *out, unsigned __int8 *server);");
	MakeFrame(0X106994, 0X20, 0, 0);
	MakeFunction    (0X106A20,0X106A2C);
	SetFunctionFlags(0X106A20,0x404);
	SetType(0X106A20, "void *svcGetThreadCommandBuffer(void);");
	MakeFunction    (0X106A2C,0X106A4C);
	SetFunctionFlags(0X106A2C,0x404);
	SetType(0X106A2C, "Result __stdcall svcControlMemory(u32 *addr_out, u32 addr0, u32 addr1, u32 size, MemOp op, MemPerm perm);");
	MakeFrame(0X106A2C, 0X8, 0, 0);
	MakeLocal(0X106A2C, 0X106A4C, "[bp+0]", "operation");
	MakeLocal(0X106A2C, 0X106A4C, "[bp+0X4]", "permissions");
	...
	MakeLocal(0X106A54, 0X106A74, "[bp+0]", "threadpriority");
	MakeLocal(0X106A54, 0X106A74, "[bp+0X4]", "processorid");
	...
	SetType(0X106B08, "Result __stdcall svcCloseHandle(Handle handle);");
	...
	SetFunctionFlags(0X106BA8,0x404);
	...
	SetFunctionFlags(0X106BBC,0x404);
	SetType(0X106BBC, "Result __stdcall svcSetThreadIdealProcessor(Handle handle, u32 processorid);");
	...
	SetType(0X106BE8, "Result __stdcall svcQueryMemory(s32 info, PageInfo *out, u32 addr);");
	...
	SetType(0X106BF8, "Result __stdcall svcTerminateProcess(Handle thread);");
	...
	SetFunctionFlags(0X106C14,0x404);
	...
	SetFunctionFlags(0X106C2C,0x404);
	...
	SetFunctionFlags(0X106C34,0x404);
	...
	SetFunctionFlags(0X106C54,0x404);
	...
	SetFunctionFlags(0X106CA0,0x404);
	SetType(0X106CA0, "Result __stdcall svcDebugActiveProcess(s32 *handle_out, u32 pid);");
	MakeFrame(0X106CA0, 0X4, 0, 0);
	MakeFunction    (0X106CB4,0X106CBC);
	SetFunctionFlags(0X106CB4,0x404);
	...
	SetFunctionFlags(0X106CBC,0x404);
	SetType(0X106CBC, "Result __stdcall svcWriteProcessMemory(Handle debug, const void *buffer, u32 addr, u32 size);");
	...
	MakeFunction    (0X106FCC,0X106FF4);
	SetFunctionFlags(0X106FCC,0x400);
	MakeFrame(0X106FCC, 0X8, 0, 0);
	MakeFunction    (0X106FFC,0X107018);
	SetFunctionFlags(0X106FFC,0x400);
	MakeFrame(0X106FFC, 0, 0, 0);
	...
	SetType(0X10704C, "void *__stdcall arm11kCmdGetKernelObject(Handle handle);");
	MakeFrame(0X10704C, 0X8, 0, 0);
	MakeFunction    (0X10707C,0X107098);
	SetFunctionFlags(0X10707C,0x400);
	SetType(0X10707C, "Result __cdecl arm11kCmdMemcpy(void *dst, void *src, size_t count);");
	MakeFrame(0X10707C, 0, 0, 0);
	MakeFunction    (0X1070A0,0X1070B8);
	SetFunctionFlags(0X1070A0,0x400);
	MakeFrame(0X1070A0, 0, 0, 0);
	MakeFunction    (0X1070C0,0X1070C4);
	SetFunctionFlags(0X1070C0,0x440);
	...
	SetType(0X10712C, "void debounceKey(void);");
	...
	SetType(0X107188, "void update_screen(void);");
	...
	SetType(0X107574, "int __stdcall showMsg(u8 *msg);");
	...
	SetType(0X107634, "void __stdcall showDbg(char *fmt, u32 errno, u32 v2);");
	...
	MakeFunction    (0X107748,0X10780C);
	SetFunctionFlags(0X107748,0x400);
	MakeFrame(0X107748, 0X130, 0, 0);
	MakeLocal(0X107748, 0X10780C, "[bp-0X114]", "openflags");
	MakeLocal(0X107748, 0X10780C, "[bp-0X110]", "attributes");
	MakeLocal(0X107748, 0X10780C, "[bp-0X104]", "out");
	MakeFunction    (0X107818,0X10784C);
	SetFunctionFlags(0X107818,0x400);
	SetType(0X107818, "void __stdcall xputc(char c);");
	MakeFunction    (0X107854,0X107874);
	SetFunctionFlags(0X107854,0x400);
	SetType(0X107854, "void __stdcall xputs(const char *str);");
	MakeFrame(0X107854, 0X8, 0, 0);
	MakeFunction    (0X107874,0X1078A8);
	SetFunctionFlags(0X107874,0x400);
	SetType(0X107874, "void __stdcall xfputs(void (__stdcall *func)(unsigned __int8), const char *str);");
	MakeFrame(0X107874, 0X10, 0, 0);
	MakeFunction    (0X1078AC,0X107B68);
	SetFunctionFlags(0X1078AC,0x404);
	SetType(0X1078AC, "void __stdcall xvprintf(const char *fmt, va_list arp);");
	MakeFrame(0X1078AC, 0X40, 0, 0);
	MakeLocal(0X1078AC, 0X107B68, "[bp-0X38]", "s");
	MakeFunction    (0X107B68,0X107B90);
	SetFunctionFlags(0X107B68,0x400);
	SetType(0X107B68, "void xprintf(const char *fmt, ...);");
	...
	SetType(0X107B90, "void xsprintf(char *buff, const char *fmt, ...);");
	...
	MakeFunction    (0X107BD4,0X107C0C);
	SetFunctionFlags(0X107BD4,0x400);
	SetType(0X107BD4, "void xfprintf(void (__stdcall *func)(unsigned __int8), const char *fmt, ...);");
	MakeFrame(0X107BD4, 0X20, 0, 0);
	MakeLocal(0X107BD4, 0X107C0C, "[bp-0XC]", "varg_r1");
	MakeLocal(0X107BD4, 0X107C0C, "[bp-0X8]", "varg_r2");
	MakeLocal(0X107BD4, 0X107C0C, "[bp-0X4]", "varg_r3");
	MakeFunction    (0X107C10,0X107CCC);
	SetFunctionFlags(0X107C10,0x400);
	SetType(0X107C10, "void __stdcall put_dump(const void *buff, unsigned __int32 addr, int len, int width);");
	MakeFrame(0X107C10, 0X10, 0, 0);
	MakeFunction    (0X107CDC,0X107D8C);
	SetFunctionFlags(0X107CDC,0x400);
	SetType(0X107CDC, "int __stdcall xgets(char *buff, int len);");
	MakeFunction    (0X107D90,0X107DB4);
	SetFunctionFlags(0X107D90,0x404);
	SetType(0X107D90, "int __stdcall xfgets(unsigned __int8 (*func)(void), char *buff, int len);");
	MakeFrame(0X107D90, 0X10, 0, 0);
	MakeFunction    (0X107DB8,0X107EE0);
	SetFunctionFlags(0X107DB8,0x404);
	SetType(0X107DB8, "int __stdcall xatoi(char **str, __int32 *res);");
...
static SegRegs(void) {
	...
	SetRegEx(0X10AB4D,"T",0,2);
	SetRegEx(0X10AB50,"T",0,2);
